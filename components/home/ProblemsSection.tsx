    ...
    <section className="py-16 lg:py-20 bg-white">
      <div className="max-w-4xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
          {problems.map((problem, index) => {
            ...
            return (
              <div
                key={index}
                className="flex items-center gap-4 bg-secondary-50 rounded-xl p-4 border-l-4 border-l-primary-500 border border-secondary-100"
              >
        ...
        <div className="text-center">
          <Link
            href="/diensten"
            className="inline-flex items-center justify-center px-6 py-3 text-base font-semibold text-primary-700 border-2 border-primary-300 hover:bg-primary-50 rounded-xl transition-colors"
          >
