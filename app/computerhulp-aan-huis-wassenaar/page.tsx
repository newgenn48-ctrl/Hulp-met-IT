...
const CITY = 'Wassenaar'
const SLUG = 'wassenaar'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Wassenaar Centrum, Wassenaar Dorp, Duindigt, De Kieviet, Oud-Wassenaar, Kasteel De Wittenburg, Voorschoten, Leidschendam, Katwijk. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisWassenaar() {
