...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Zundert Centrum, Rijsbergen, Achtmaal, Klein Zundert, Wernhout, Zundert Noord. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisZundert() {
