...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Vlijmen, Drunen, Heusden Vesting, Elshout, Haarsteeg, Nieuwkuijk, Oudheusden, Hedikhuizen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisHeusdenPage() {
