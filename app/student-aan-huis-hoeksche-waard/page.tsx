...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Oud-Beijerland, Strijen, Numansdorp, Klaaswaal, 's-Gravendeel, Puttershoek, Piershil, Zuid-Beijerland, Maasdam, Westmaas. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisHoekscheWaardPage() {
