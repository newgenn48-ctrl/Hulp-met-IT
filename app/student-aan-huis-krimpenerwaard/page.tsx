...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Schoonhoven, Bergambacht, Lekkerkerk, Haastrecht, Stolwijk, Vlist, Ammerstol, Berkenwoude, Gouderak. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisKrimpenerwaardPage() {
