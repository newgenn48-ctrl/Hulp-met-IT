...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Berkel en Rodenrijs, Bergschenhoek, Bleiswijk, Noordeinde, Kruisweg, Rotte, Wilderszijde. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisLansingerlandPage() {
