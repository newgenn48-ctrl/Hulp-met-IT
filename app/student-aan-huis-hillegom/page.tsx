...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Hillegom Centrum, Elsbroek, Hillegom-Noord, Hillegom-Zuid, Pastoorslaan-gebied, Ringvaart-omgeving. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisHillegomPage() {
