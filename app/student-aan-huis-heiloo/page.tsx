...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Heiloo, Ypestein, Zuiderloo, Heiloo-Centrum, Heiloo-Oost, Heiloo-West. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisHeilooPage() {
