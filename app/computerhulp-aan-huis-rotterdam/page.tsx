...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Rotterdam Centrum, Rotterdam Noord, Rotterdam Oost, Rotterdam West, Rotterdam Zuid, Kralingen-Crooswijk, Hillegersberg-Schiebroek, Hoek van Holland, Capelle aan den IJssel, Schiedam. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisRotterdam() {
