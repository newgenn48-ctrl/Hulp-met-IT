...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Bodegraven, Reeuwijk-Dorp, Reeuwijk-Brug, Nieuwerbrug, Driebruggen, Waarder, Tempel. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisBodegravenReeuwijkPage() {
