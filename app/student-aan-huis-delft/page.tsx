...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Delft Centrum, Delft Noord, Delft Oost, Delft West, Delft Zuid, Tanthof, Voorhof, Buitenhof, Vrijenban, Pijnacker. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisDelftPage() {
