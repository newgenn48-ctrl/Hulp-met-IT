...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Delft voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Delft Centrum, Delft Noord, Delft Oost en omgeving. €15,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Delft | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Delft. Wij komen bij u thuis in Delft en omgeving. €15,50 per kwartier.',
