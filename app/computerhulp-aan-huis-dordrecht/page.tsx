...
const CITY = 'Dordrecht'
const SLUG = 'dordrecht'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Dordrecht Centrum, Dordrecht Noord, Dordrecht Oost, Dordrecht West, Dordrecht Zuid, Wielwijk, Dubbeldam, Sterrenburg, Krispijn, Papendrecht. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]
