...
const faqData = [
  {
    ...
    answer: "Onze computerhulp aan huis in Dordrecht kost €14,50 per kwartier, met een minimum van 3 kwartier. Voorrijkosten zijn €10 eenmalig. U betaalt achteraf."
  },
  {
