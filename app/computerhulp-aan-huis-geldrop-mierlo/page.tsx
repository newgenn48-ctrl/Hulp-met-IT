...
const CITY = 'Geldrop-Mierlo'
const SLUG = 'geldrop-mierlo'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Geldrop Centrum, Mierlo Centrum, Braakhuizen, Zesgehuchten, Skandia, Coevering, Nuenen, Heeze, Eindhoven. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisGeldropMierlo() {
