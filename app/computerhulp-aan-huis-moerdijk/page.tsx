...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Zevenbergen, Klundert, Fijnaart, Willemstad, Standdaarbuiten, Moerdijk dorp, Langeweg, Zevenbergschen Hoek. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisMoerdijk() {
