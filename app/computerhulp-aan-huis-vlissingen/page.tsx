...
const CITY = 'Vlissingen'
const SLUG = 'vlissingen'
const REGION = 'Zeeland'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Vlissingen Centrum, Vlissingen Boulevard, Oost-Souburg, Paauwenburg, Westerzicht, Rosenburg, Middelburg, Koudekerke. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisVlissingen() {
