...
const faqData = [
  {
    question: "Wat kost computerhulp aan huis in Vlissingen?",
    answer: "Onze computerhulp aan huis in Vlissingen kost \u20AC14,50 per kwartier, met een minimum van 3 kwartier. Voorrijkosten zijn \u20AC10 eenmalig. U betaalt achteraf."
  },
  {
    question: "Hoe snel kan een student bij mij thuis komen in Vlissingen?",
    answer: "In de meeste gevallen kunnen wij binnen 24-48 uur bij u langskomen in Vlissingen. Voor spoedgevallen bieden wij vaak nog dezelfde dag service aan."
  },
  {
    question: "Welke computerproblemen lossen jullie op in Vlissingen?",
  ...
  },
  {
    ...
    answer: "Ja, wij hebben ruime ervaring met computerhulp aan huis in Vlissingen en omgeving. Onze studenten zijn HBO-opgeleid en kunnen vrijwel elk computerprobleem oplossen."
  },
  {
    question: "Werken jullie ook in het weekend in Vlissingen?",
    answer: "Ja, wij zijn 7 dagen per week beschikbaar van 08:00 tot 21:00 uur. Ook in het weekend kunt u dus rekenen op onze computerhulp aan huis in Vlissingen."
  }
]
...
export default function ComputerhulpAanHuisVlissingen() {
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'Computerhulp aan huis Vlissingen',
        item: 'https://hulpmetit.nl/computerhulp-aan-huis-vlissingen'
      }
    ]
  }
  ...
  const localBusinessStructuredData = {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    name: 'Hulp met IT - Computerhulp aan Huis Vlissingen',
    description: 'Professionele computerhulp aan huis in Vlissingen door HBO-opgeleide ICT-studenten',
    ...
    serviceType: 'Computerhulp aan huis Vlissingen',
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Computerhulp aan huis in Vlissingen"
          fill
          priority
          ...
          <div className="max-w-2xl">
            <ScrollReveal>
              ...
              <h1 className="text-4xl sm:text-5xl xl:text-6xl font-extrabold text-white leading-[1.1] mb-6">
                Computerhulp{' '}
                <span className="text-accent-400">aan huis in Vlissingen</span>
              </h1>

              <p className="text-lg text-white/80 leading-relaxed mb-8 max-w-lg">
                Een HBO-opgeleide student komt bij u thuis in Vlissingen, lost het probleem op en legt alles uit in gewone taal. Zo kunt u er weer tegenaan.
              </p>
      ...
      <CityAboutSection citySlug="vlissingen" pageType="computerhulp" />
            ...
            <ScrollReveal>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900 mb-4">
                  Computerhulp aan huis in heel Vlissingen
                </h2>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={300}>
              <div className="text-center">
                <p className="text-secondary-500 text-lg leading-relaxed max-w-3xl mx-auto">
                  Hulp met IT biedt computerhulp aan huis in heel Vlissingen. Onze vriendelijke studenten komen naar u toe en helpen u rustig en geduldig met uw computerproblemen. Betaalbaar en bij u thuis.
                </p>
              </div>
            </ScrollReveal>
          </div>
      ...
      <NearbyCities currentCitySlug="vlissingen" pageType="computerhulp" />
          ...
          <ScrollReveal>
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900">
                Veelgestelde vragen over computerhulp aan huis Vlissingen
              </h2>
            </div>
          </ScrollReveal>
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/student-aan-huis-vlissingen" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
