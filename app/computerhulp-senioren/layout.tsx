...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'ict hulp ouderen',
    'geduldig computerhulp ouderen',
    'computer uitleg senioren',
    'thuishulp computer ouderen',
    'senioren tablet cursus',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Computerhulp voor senioren aan huis - Hulp met IT'
      }
    ],
  },
  twitter: {
