...
const helpTopics = [
  { icon: Mail, title: 'E-mail & berichten', description: 'Hulp met e-mail instellen, bijlagen versturen en WhatsApp gebruiken.' },
  { icon: Globe, title: 'Internet & veiligheid', description: 'Veilig internetten, online bankieren en nep-mails herkennen.' },
  { icon: Smartphone, title: 'Tablet & smartphone', description: 'Uw iPad, Samsung tablet of smartphone leren gebruiken.' },
  { icon: Camera, title: "Foto's & bestanden", description: "Foto's overzetten, opslaan en delen met familie en vrienden." },
  { icon: Shield, title: 'Beveiliging', description: 'Wachtwoorden beheren, virussen voorkomen en privacy beschermen.' },
  { icon: Heart, title: 'Geduldig uitleggen', description: 'Stap voor stap uitleg in gewone taal, zo vaak als nodig.' },
]

const faqData = [
  {
    question: 'Is de uitleg geschikt voor beginners?',
    answer: 'Absoluut! Onze studenten zijn getraind om geduldig uit te leggen in begrijpelijke taal, zonder technisch jargon. We passen ons tempo aan uw niveau aan.'
  },
  {
    question: 'Kunnen jullie ook helpen met een tablet of smartphone?',
    answer: 'Ja, wij helpen met alle apparaten: computers, laptops, tablets (iPad, Samsung) en smartphones (iPhone, Android).'
  },
  {
  ...
  },
  {
    ...
    answer: 'Natuurlijk! Veel senioren plannen regelmatig een afspraak in. Zo leert u stap voor stap steeds meer en kunt u vragen stellen wanneer die opkomen.'
  },
  {
...
export default function ComputerhulpSeniorenPage() {
  ...
  const serviceStructuredData = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Computerhulp voor Senioren aan Huis',
    alternateName: ['Computerhulp ouderen', 'Digitale hulp senioren', 'Tablet hulp ouderen'],
          ...
          <div className="max-w-2xl">
            <ScrollReveal>
              <h1 className="text-4xl sm:text-5xl xl:text-6xl font-extrabold text-white leading-[1.1] mb-6">
                Computerhulp{' '}
                <span className="text-accent-400">voor senioren</span>
              </h1>

              <p className="text-lg text-white/80 leading-relaxed mb-8 max-w-lg">
                Moeite met de computer, tablet of smartphone? Onze geduldige student komt bij u thuis en legt alles rustig uit in gewone taal. Geen haast, geen jargon.
              </p>
              ...
              <p className="text-accent-400 text-sm font-medium mb-8">
                Geduldige uitleg, stap voor stap
              </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900 mb-4">
                Waar helpen wij senioren mee?
              </h2>
              <p className="text-secondary-500 max-w-xl mx-auto text-lg">
                Van e-mail tot tablets — wij helpen u met alles, op uw eigen tempo.
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {helpTopics.map((topic, index) => (
              <ScrollReveal key={topic.title} delay={index * 80}>
                <div className="bg-white rounded-2xl p-6 shadow-card hover:shadow-card-hover transition-all duration-300">
                  <topic.icon className="w-8 h-8 text-primary-500 mb-4" />
                  <h3 className="font-bold text-secondary-900 mb-2">{topic.title}</h3>
                  <p className="text-secondary-500 text-sm leading-relaxed">{topic.description}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900 mb-4">
                Computerhulp voor senioren in heel Nederland
              </h2>
              <p className="text-secondary-500 max-w-xl mx-auto text-lg">
