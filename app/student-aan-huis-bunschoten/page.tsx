...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Bunschoten, Spakenburg, Eemdijk, Zevenhuizen, Hoogland, Vathorst. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisBunschotenPage() {
