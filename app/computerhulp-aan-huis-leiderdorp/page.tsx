...
const CITY = 'Leiderdorp'
const SLUG = 'leiderdorp'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Leiderdorp Centrum, Bloemerd, Buitenhof, De Houtkamp, Elisabethhof, Ouderzorg, Voorhof. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisLeiderdorp() {
