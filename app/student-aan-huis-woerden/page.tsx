...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Woerden Centrum, Snel en Polanen, Molenvliet, Staatsliedenkwartier, Harmelen, Kamerik, Zegveld, Montfoort, Oudewater. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisWoerdenPage() {
