...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Doorn, Driebergen-Rijsenburg, Amerongen, Maarn, Leersum, Overberg, Woudenberg, Maarsbergen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisUtrechtseHeuvelrugPage() {
