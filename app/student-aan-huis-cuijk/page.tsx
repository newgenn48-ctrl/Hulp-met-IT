...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Cuijk Centrum, Cuijk Noord, Cuijk Zuid, Beers, Vianen, Haps, Grave, Mill, Boxmeer. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisCuijkPage() {
