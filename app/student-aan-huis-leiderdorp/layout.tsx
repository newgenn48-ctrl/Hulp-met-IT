...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Leiderdorp voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Leiderdorp Centrum, Bloemerd, Buitenhof en omgeving. €15,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Leiderdorp | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Leiderdorp. Wij komen bij u thuis in Leiderdorp en omgeving. €15,50 per kwartier.',
