...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Leiderdorp Centrum, Bloemerd, Buitenhof, De Houtkamp, Elisabethhof, Ouderzorg, Voorhof. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisLeiderdorpPage() {
