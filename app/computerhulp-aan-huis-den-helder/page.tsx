...
const CITY = 'Den Helder'
const SLUG = 'den-helder'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Den Helder Centrum, Nieuw-Den Helder, De Schooten, Julianadorp, Huisduinen, Van Foreestbuurt, Texel, Schagen, Anna Paulowna. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisDenHelder() {
