...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Utrecht Centrum, Utrecht Noord, Utrecht Oost, Utrecht West, Utrecht Zuid, Leidsche Rijn, Overvecht, Kanaleneiland, Nieuwegein, IJsselstein. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisUtrechtPage() {
