...
const utrechtAreas = [
  ...
  'Utrecht West', 'Overvecht', 'Zuilen', 'Nieuwegein',
  'IJsselstein', 'Houten', 'Zeist', 'Bunnik'
]
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Betaalbare computerhulp in Utrecht door ervaren IT-studenten",
          ...
          <div className="max-w-7xl mx-auto container-padding">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-neural-300 max-w-4xl mx-auto leading-relaxed mb-8">
                Computerproblemen in Utrecht? Onze IT-studenten komen naar je toe! Betaalbare hulp door lokale studenten. 
        ...
        <section className="section-spacing bg-white/5">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-neural-300">
                Snel, lokaal en betaalbaar - vakkundige hulp in Utrecht
              </p>
            </div>
