...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Laren voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Laren Centrum, Laren Noord, Laren Oost en omgeving. €14,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Laren | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Laren. Wij komen bij u thuis in Laren en omgeving. €14,50 per kwartier.',
