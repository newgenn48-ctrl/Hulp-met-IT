...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Laren Centrum, Laren Noord, Laren Oost, Laren West, Laren Zuid, Blaricum, Hilversum, Bussum, Eemnes, Huizen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisLarenPage() {
