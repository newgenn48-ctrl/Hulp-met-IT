...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Ridderkerk Centrum, Drievliet, Bolnes, Slikkerveer, Rijsoord, Donkersloot, Ridderkerk-West, Ridderkerk-Oost. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisRidderkerkPage() {
