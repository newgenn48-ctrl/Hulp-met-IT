...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: IJmuiden, Velserbroek, Santpoort-Noord, Santpoort-Zuid, Velsen-Noord, Velsen-Zuid, Driehuis, IJmuiden-Oost. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisVelsenPage() {
