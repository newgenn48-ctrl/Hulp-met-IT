...
const CITY = 'Molenlanden'
const SLUG = 'molenlanden'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Groot-Ammers, Bleskensgraaf, Nieuw-Lekkerland, Kinderdijk, Oud-Alblas, Brandwijk, Molenaarsgraaf, Goudriaan, Streefkerk, Wijngaarden. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisMolenlanden() {
