...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Naaldwijk, Monster, 's-Gravenzande, Wateringen, De Lier, Honselersdijk, Poeldijk, Kwintsheul, Ter Heijde, Maasdijk. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisWestlandPage() {
