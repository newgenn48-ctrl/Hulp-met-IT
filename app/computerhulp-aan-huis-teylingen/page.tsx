...
const CITY = 'Teylingen'
const SLUG = 'teylingen'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Sassenheim, Voorhout, Warmond, Sassenheim-Noord, Sassenheim-Zuid, Voorhout-West, Voorhout-Oost. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisTeylingen() {
