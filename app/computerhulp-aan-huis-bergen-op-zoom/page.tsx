...
const CITY = 'Bergen op Zoom'
const SLUG = 'bergen-op-zoom'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Bergen op Zoom Centrum, Bergen op Zoom Noord, Bergen op Zoom Oost, Bergse Plaat, Gageldonk, Halsteren, Lepelstraat, Hoogerheide. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisBergenOpZoom() {
