...
const CITY = 'Alblasserdam'
const SLUG = 'alblasserdam'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Alblasserdam Centrum, Souburgh, Babylonienburg, Kinderdijk-omgeving, Blokweer, Alblasserdam-West. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisAlblasserdam() {
