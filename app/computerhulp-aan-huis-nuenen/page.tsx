...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Nuenen Centrum, Gerwen, Nederwetten, Nuenen Zuid, Nuenen West, Eeneind, Opwetten. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisNuenen() {
