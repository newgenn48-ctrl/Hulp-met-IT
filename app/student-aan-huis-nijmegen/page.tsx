...
const benefits = [
  ...
  },
  {
    icon: GraduationCap,
    title: 'IT-Studenten',
    description: 'Studenten van Radboud Universiteit en HAN, vertrouwd met moderne systemen.'
  },
  {
    icon: Clock,
...
export default function StudentAanHuisCityPage() {
  ...
  const serviceStructuredData = {
    ...
    description: `Betaalbare computerhulp door ervaren IT-studenten van Radboud Universiteit en HAN aan huis in ${CITY}`,
    provider: {
      '@type': 'LocalBusiness',
      name: 'Hulp met IT',
