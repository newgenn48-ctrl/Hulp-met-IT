...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Nijmegen Centrum, Nijmegen Noord, Nijmegen Oost, Nijmegen West, Nijmegen Zuid, Waalsprong, Dukenburg, Lindenholt, Wijchen, Beuningen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisNijmegenPage() {
