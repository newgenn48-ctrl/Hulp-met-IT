...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Nuenen Centrum, Gerwen, Nederwetten, Nuenen Zuid, Nuenen West, Eeneind, Opwetten. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisNuenenPage() {
