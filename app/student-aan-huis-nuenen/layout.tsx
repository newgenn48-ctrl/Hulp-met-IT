...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Nuenen voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Nuenen Centrum, Gerwen, Nederwetten en omgeving. €14,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Nuenen | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Nuenen. Wij komen bij u thuis in Nuenen en omgeving. €14,50 per kwartier.',
