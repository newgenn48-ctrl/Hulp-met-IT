...
const CITY = 'Sint-Michielsgestel'
const SLUG = 'sint-michielsgestel'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Sint-Michielsgestel, Berlicum, Den Dungen, Gemonde, Middelrode, Sint-Michielsgestel Centrum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisSintMichielsgestel() {
