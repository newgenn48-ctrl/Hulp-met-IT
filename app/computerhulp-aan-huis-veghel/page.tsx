...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Veghel Centrum, Veghel Noord, Veghel Zuid, Eerde, Zijtaart, Sint-Oedenrode, Schijndel, Erp, Uden. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisVeghel() {
