...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Hoogerheide, Huijbergen, Putte, Ossendrecht, Woensdrecht dorp, Calfven, Hoogerheide Centrum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisWoensdrechtPage() {
