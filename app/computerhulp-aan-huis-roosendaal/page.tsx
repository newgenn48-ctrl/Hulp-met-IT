...
const CITY = 'Roosendaal'
const SLUG = 'roosendaal'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Roosendaal Centrum, Roosendaal Noord, Roosendaal Oost, Tolberg, Kroeven, Langdonk, Nispen, Wouw. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisRoosendaal() {
