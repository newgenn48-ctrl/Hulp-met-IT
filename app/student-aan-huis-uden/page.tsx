...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Uden Centrum, Uden Noord, Uden Zuid, Uden Oost, Volkel, Odiliapeel, Veghel, Mill. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
