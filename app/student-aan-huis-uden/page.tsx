...
const faqData = [
  ...
  },
  {
    ...
    answer: `We bedienen heel ${CITY} en omgeving, inclusief Uden Centrum, Uden Noord, Uden Zuid, Uden Oost, Volkel, Odiliapeel en meer.`
  }
]

export default function StudentAanHuisUdenPage() {
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: 'https://hulpmetit.nl/student-aan-huis-uden'
      }
    ]
  }
  ...
  return (
    <>
      ...
      <CityAboutSection citySlug="uden" pageType="student" />
            ...
            <ScrollReveal>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900 mb-4">
                  Student aan huis in Uden en omgeving
                </h2>
              </div>
            </ScrollReveal>
      ...
      <NearbyCities currentCitySlug="uden" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-uden" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
