...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Uden voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Uden Centrum, Uden Noord, Uden Zuid en omgeving. €14,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Uden | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Uden. Wij komen bij u thuis in Uden en omgeving. €14,50 per kwartier.',
