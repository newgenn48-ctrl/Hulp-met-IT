...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Maarssen, Breukelen, Loenen aan de Vecht, Nieuwersluis, Nigtevecht, Oud-Zuilen, Tienhoven, Vreeland. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisStichtseVechtPage() {
