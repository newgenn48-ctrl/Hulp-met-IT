...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Loosdrecht, Nederhorst den Berg, Kortenhoef, Ankeveen, Breukeleveen, Nieuw-Loosdrecht, Oud-Loosdrecht. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisWijdemerenPage() {
