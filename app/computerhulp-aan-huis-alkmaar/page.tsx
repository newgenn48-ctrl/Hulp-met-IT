...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Alkmaar Centrum, Alkmaar Noord, Alkmaar Oost, Overdie, De Mare, Koedijk, Heerhugowaard, Bergen, Heiloo, Castricum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisAlkmaar() {
