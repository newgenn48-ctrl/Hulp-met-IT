...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Leiden Centrum, Leiden Noord, Leiden Oost, Leiden West, Leiden Zuid, Leidse Hout, Merenwijk, Stevenshof, Roomburg, Oegstgeest. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisLeidenPage() {
