...
const CITY = 'Terneuzen'
const SLUG = 'terneuzen'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Terneuzen Centrum, Terneuzen Noord, Terneuzen Zuid, Sluiskil, Biervliet, Hoek, Axel, Westdorpe. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisTerneuzen() {
