...
const CITY = 'Enkhuizen'
const SLUG = 'enkhuizen'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Enkhuizen-Centrum, Gommerwijk, Fruittuinen, Kadijken, Westerstrand, Enkhuizen-Zuid. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisEnkhuizen() {
