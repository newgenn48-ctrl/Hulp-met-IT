...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Pijnacker, Nootdorp, Delfgauw, Ackerswoude, Pijnacker-Zuid, Klapwijk, Emerald. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisPijnackerNootdorpPage() {
