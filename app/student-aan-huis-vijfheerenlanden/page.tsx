...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Vianen, Leerdam, Meerkerk, Lexmond, Hagestein, Everdingen, Ameide, Nieuwland, Ossenwaard. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisVijfheerenlandenPage() {
