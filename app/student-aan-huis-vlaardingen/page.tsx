...
const faqData = [
  ...
  },
  {
    ...
    answer: `We bedienen alle wijken van ${CITY}: Centrum, Oost, Holy, Westwijk, plus omliggende gemeenten zoals Schiedam, Maassluis, Rotterdam, Delft, Hoek van Holland, Rozenburg, Spijkenisse en Pernis.`
  },
  {
