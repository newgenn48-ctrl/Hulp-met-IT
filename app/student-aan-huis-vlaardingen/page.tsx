...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Vlaardingen Centrum, Vlaardingen Noord, Vlaardingen Oost, Vlaardingen West, Vlaardingen Zuid, Westwijk, Ambacht, Holy, Schiedam, Maassluis. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisVlaardingenPage() {
