    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Student aan huis in Vlaardingen"
          fill
          priority
      ...
      <CityAboutSection citySlug="vlaardingen" pageType="student" />
      ...
      <NearbyCities currentCitySlug="vlaardingen" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-vlaardingen" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
