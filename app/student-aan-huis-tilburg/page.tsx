...
const processSteps = [
  {
    step: '1',
    title: 'Plan Afspraak',
    description: 'Bel of plan online - binnen Tilburg snel beschikbaar'
  },
  {
    step: '2', 
    title: 'Student Komt Langs',
    description: 'IT-student komt naar je adres in Tilburg'
  },
  {
    step: '3',
...
const tilburgAreas = [
  'Tilburg Centrum', 'Tilburg Noord', 'Tilburg Oost', 'Tilburg West',
  'Tilburg Zuid', 'Reeshof', 'Stokhasselt', 'Berkel-Enschot',
  'Udenhout', 'Goirle', 'Hilvarenbeek', 'Oisterwijk'
]

const faqData = [
  {
    question: "Wat kost student aan huis hulp in Tilburg?",
    answer: "Onze tarieven beginnen vanaf €53,50 (€10 voorrijkosten + 3 x €14,50) in Tilburg. Dit is veel voordeliger dan traditionele computerhulp services. Je betaalt alleen voor de daadwerkelijk bestede tijd, geen voorrijkosten of minimumtarief."
  },
  {
    question: "Zijn jullie studenten wel gekwalificeerd in Tilburg?",
    answer: "Ja, onze studenten in Tilburg volgen IT-opleidingen en hebben praktijkervaring. Veel van onze studenten komen van Tilburg University en zijn vertrouwd met moderne technologie. Ze worden geselecteerd op hun technische vaardigheden en communicatieve vaardigheden."
  },
  {
    question: "Kunnen jullie ook 's avonds en weekenden komen in Tilburg?",
    answer: "Ja, dat is een van onze grote voordelen! Onze studenten in Tilburg hebben flexibele schema's en kunnen vaak ook 's avonds en in weekenden. We zijn bereikbaar van 08:00 tot 22:00, 7 dagen per week."
  },
  {
    question: "Hoe snel kunnen jullie komen in Tilburg?",
    answer: "In Tilburg kunnen we vaak nog dezelfde dag langskomen, vooral 's avonds en in weekenden. Voor urgent problemen proberen we binnen 2-4 uur beschikbaar te zijn in het centrum en de hoofdwijken."
  },
  {
    question: "Welke wijken in Tilburg bedienen jullie?",
    answer: "We bedienen alle wijken van Tilburg: Centrum, Noord, Oost, West, Zuid, Reeshof, Stokhasselt, plus omliggende gemeenten zoals Goirle, Hilvarenbeek en Oisterwijk."
  }
]
...
export default function StudentAanHuisTilburgLanding() {
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Student aan huis Tilburg",
                "item": "https://hulpmetit.nl/student-aan-huis-tilburg"
              }
            ]
          })
        }}
...
<script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Hulp met IT - Student Aan Huis Tilburg",
            "description": "Betaalbare computerhulp in Tilburg door ervaren IT-studenten. Tilburg University studenten bieden professionele hulp.",
            ...
            "serviceType": "Student aan huis Tilburg",
            ...
            "offers": {
              "@type": "Offer",
              "description": "Computerhulp door IT-studenten in Tilburg",
              "price": "53.50",
              "priceCurrency": "EUR",
      ...
      <nav aria-label="Breadcrumb" className="bg-white/50 backdrop-blur-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto container-padding py-3">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li>
              <span className="text-gray-700 font-medium">Student aan huis Tilburg</span>
            </li>
          </ol>
        </div>
      </nav>
      ...
      <div className="relative">
          ...
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Hoe Werkt Student Aan Huis in Tilburg?
              </h2>
              <p className="text-xl text-secondary-700">
                Snel, lokaal en betaalbaar - vakkundige hulp in Tilburg
              </p>
            </div>
        ...
        <section className="section-spacing bg-neural-900/30">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Waarom Kiezen Voor Student Aan Huis Tilburg?
              </h2>
              <p className="text-xl text-secondary-700 max-w-3xl mx-auto">
                Ontdek de voordelen van computerhulp door ervaren IT-studenten in Tilburg
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="glass-effect rounded-lg p-6">
                ...
                <h3 className="text-xl font-semibold text-secondary-800 mb-3">Betaalbare Tarieven Tilburg</h3>
                <p className="text-secondary-700 leading-relaxed">
                  Vanaf €53,50 (€10 voorrijkosten + 3 x €14,50) in Tilburg - veel goedkoper dan traditionele computerhulp. Perfecte kwaliteit tegen studententarieven.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <h3 className="text-xl font-semibold text-secondary-800 mb-3">Tilburg University Studenten</h3>
                <p className="text-secondary-700 leading-relaxed">
                  Onze studenten in Tilburg komen vaak van Tilburg University en zijn opgeleid in de nieuwste technologieën. Lokale kennis, professionele hulp.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Ook 's avonds en in weekenden beschikbaar in Tilburg. Studenten hebben flexibele schema's die perfect aansluiten bij uw behoeften.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <h3 className="text-xl font-semibold text-secondary-800 mb-3">Heel Tilburg</h3>
                <p className="text-secondary-700 leading-relaxed">
                  Van Centrum tot Reeshof, van Noord tot Zuid - onze studenten komen overal in Tilburg en omgeving zoals Goirle en Oisterwijk.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Vaak nog dezelfde dag beschikbaar in Tilburg. Korte reistijd betekent snelle hulp en lagere kosten.
                </p>
              </div>
        ...
        <section className="section-spacing">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Onze Student IT Diensten in Tilburg
              </h2>
              <p className="text-xl text-secondary-700">
                Uitgebreide computerhulp door vakkundige IT-studenten in Tilburg
              </p>
            </div>

            <div className="grid lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-secondary-800 mb-4">🖥️ Computer & Laptop Hulp Tilburg</h3>
              ...
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-secondary-800 mb-4">🌐 Internet & Netwerk Tilburg</h3>
        ...
        <section className="section-spacing bg-neural-900/50">
          ...
          <div className="max-w-4xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Veelgestelde Vragen Student Aan Huis Tilburg
              </h2>
              <p className="text-xl text-secondary-700">
                Antwoorden op de meest gestelde vragen over onze student IT service in Tilburg
              </p>
            </div>
        ...
        {/* Tilburg Areas Section */}
        <section className="section-spacing">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Werkgebied Tilburg & Omgeving
              </h2>
              <p className="text-xl text-secondary-700">
                Onze IT-studenten komen naar alle wijken in en rondom Tilburg
              </p>
            </div>

            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
              {tilburgAreas.map((area, index) => (
            ...
            <div className="text-center">
              ...
              <Link href="/regios/tilburg" className="btn-secondary">
        ...
        <section className="section-spacing bg-gradient-to-br from-primary-50 via-white to-accent-50">
          <div className="max-w-4xl mx-auto container-padding text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-6">
              Klaar voor Betaalbare Computerhulp in Tilburg?
            </h2>
            <p className="text-xl text-primary-700 mb-8 max-w-2xl mx-auto">
              Onze ervaren IT-studenten in Tilburg staan klaar om je te helpen. Snel, betaalbaar en vakkundig!
            </p>
