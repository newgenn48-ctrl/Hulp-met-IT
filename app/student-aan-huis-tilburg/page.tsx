...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Tilburg Centrum, Tilburg Noord, Tilburg Oost, Tilburg West, Tilburg Zuid, Reeshof, Stokhasselt, Berkel-Enschot, Udenhout, Goirle. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisTilburgPage() {
