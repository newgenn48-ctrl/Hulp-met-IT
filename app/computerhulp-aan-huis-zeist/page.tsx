...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Zeist Centrum, Zeist Noord, Zeist Zuid, Austerlitz, Den Dolder, Bosch en Duin, Huis ter Heide, Driebergen-Rijsenburg, Bilthoven. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisZeist() {
