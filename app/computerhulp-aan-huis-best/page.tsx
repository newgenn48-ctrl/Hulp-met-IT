...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Best Centrum, Best Noord, Best Zuid, Aarle, Naastenbest, De Vleut, Batadorp, Oirschot, Son en Breugel. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisBest() {
