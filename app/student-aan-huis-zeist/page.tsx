...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Zeist Centrum, Zeist Noord, Zeist Zuid, Austerlitz, Den Dolder, Bosch en Duin, Huis ter Heide, Driebergen-Rijsenburg, Bilthoven. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisZeistPage() {
