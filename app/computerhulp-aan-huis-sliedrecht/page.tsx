...
const CITY = 'Sliedrecht'
const SLUG = 'sliedrecht'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Sliedrecht Centrum, Sliedrecht-Oost, Sliedrecht-West, Baanhoek, De Lock, Merwestein. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisSliedrecht() {
