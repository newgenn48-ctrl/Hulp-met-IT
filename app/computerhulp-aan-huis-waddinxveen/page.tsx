...
const CITY = 'Waddinxveen'
const SLUG = 'waddinxveen'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Waddinxveen Centrum, Vondelwijk, Zuidpunt, Groenswaard, Triangel, Bomenwijk, Noordkade. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisWaddinxveen() {
