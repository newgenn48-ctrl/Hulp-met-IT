...
const CITY = 'Pijnacker-Nootdorp'
const SLUG = 'pijnacker-nootdorp'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Pijnacker, Nootdorp, Delfgauw, Ackerswoude, Pijnacker-Zuid, Klapwijk, Emerald. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisPijnackerNootdorp() {
