...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Nieuwkoop, Ter Aar, Noorden, Zevenhoven, Nieuwveen, Langeraar, Woerdense Verlaat, Papenveer. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisNieuwkoop() {
