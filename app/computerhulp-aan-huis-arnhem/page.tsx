...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Arnhem Centrum, Arnhem Noord, Arnhem Oost, Arnhem West, Arnhem Zuid, Presikhaaf, Malburgen, Schuytgraaf, Klarendal, Velp. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisArnhem() {
