...
const CITY = 'Gorinchem'
const SLUG = 'gorinchem'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Gorinchem Centrum, Gorinchem Oost, Gorinchem West, Haarwijk, Stalkaarsen, Dalem, Leerdam, Hardinxveld-Giessendam, Sliedrecht. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisGorinchem() {
