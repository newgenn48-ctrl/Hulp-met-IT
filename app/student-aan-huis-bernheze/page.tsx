...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Heesch, Nistelrode, Loosbroek, Vorstenbosch, Heeswijk-Dinther, Middelrode. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisBernhezePage() {
