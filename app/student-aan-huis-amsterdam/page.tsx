...
const processSteps = [
  {
    step: '1',
    title: 'Plan Afspraak',
    description: 'Bel of plan online - binnen Amsterdam snel beschikbaar'
  },
  {
    step: '2', 
    title: 'Student Komt Langs',
    description: 'IT-student komt naar je adres in Amsterdam'
  },
  {
    step: '3',
...
const amsterdamAreas = [
  'Amsterdam Centrum', 'Amsterdam Noord', 'Amsterdam Zuid', 'Amsterdam Oost',
  'Amsterdam West', 'Amsterdam Zuidoost', 'Amstelveen', 'Diemen',
  'Ouderkerk aan de Amstel', 'Weesp', 'Abcoude', 'Breukelen'
]

const faqData = [
  {
    question: "Wat kost student aan huis hulp in Amsterdam?",
    answer: "Onze tarieven beginnen vanaf €53,50 (€10 voorrijkosten + 3 x €14,50) in Amsterdam. Dit is veel voordeliger dan traditionele computerhulp services. Je betaalt alleen voor de daadwerkelijk bestede tijd, geen voorrijkosten of minimumtarief."
  },
  {
    question: "Zijn jullie studenten wel gekwalificeerd in Amsterdam?",
    answer: "Ja, onze studenten in Amsterdam volgen IT-opleidingen en hebben praktijkervaring. Ze zijn vertrouwd met moderne technologie en worden geselecteerd op hun technische vaardigheden en communicatieve vaardigheden."
  },
  {
    question: "Kunnen jullie ook 's avonds en weekenden komen in Amsterdam?",
    answer: "Ja, dat is een van onze grote voordelen! Onze studenten in Amsterdam hebben flexibele schema's en kunnen vaak ook 's avonds en in weekenden. We zijn bereikbaar van 08:00 tot 22:00, 7 dagen per week."
  },
  {
    question: "Hoe snel kunnen jullie komen in Amsterdam?",
    answer: "In Amsterdam kunnen we vaak nog dezelfde dag langskomen, vooral 's avonds en in weekenden. Voor urgent problemen proberen we binnen 2-4 uur beschikbaar te zijn."
  },
  {
    question: "Welke wijken in Amsterdam bedienen jullie?",
    answer: "We bedienen alle wijken van Amsterdam: Centrum, Noord, Zuid, Oost, West, Zuidoost, plus omliggende gemeenten zoals Amstelveen, Diemen en Weesp."
  }
]
...
export default function StudentAanHuisAmsterdamLanding() {
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Student aan huis Amsterdam",
                "item": "https://hulpmetit.nl/student-aan-huis-amsterdam"
              }
            ]
          })
        }}
...
<script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Hulp met IT - Student Aan Huis Amsterdam",
            "description": "Betaalbare computerhulp in Amsterdam door ervaren IT-studenten",
            ...
            "serviceType": "Student aan huis Amsterdam",
      ...
      <nav aria-label="Breadcrumb" className="bg-white/50 backdrop-blur-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto container-padding py-3">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li>
              <span className="text-gray-700 font-medium">Student aan huis Amsterdam</span>
            </li>
          </ol>
        </div>
      </nav>
      ...
      <div className="relative">
          ...
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Hoe Werkt Student Aan Huis in Amsterdam?
              </h2>
              <p className="text-xl text-secondary-700">
                Snel, lokaal en betaalbaar - vakkundige hulp in Amsterdam
              </p>
            </div>
        ...
        <section className="section-spacing bg-neural-900/30">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Waarom kiezen voor onze Student Aan Huis in Amsterdam?
              </h2>
              <p className="text-xl text-secondary-700 max-w-3xl mx-auto">
                Ontdek de voordelen van computerhulp door ervaren IT-studenten in Amsterdam
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="glass-effect rounded-lg p-6">
                ...
                <h3 className="text-xl font-semibold text-secondary-800 mb-3">Betaalbare Tarieven Amsterdam</h3>
                <p className="text-secondary-700 leading-relaxed">
                  Vanaf €53,50 (€10 voorrijkosten + 3 x €14,50) in Amsterdam - veel goedkoper dan traditionele computerhulp. Perfecte kwaliteit tegen studententarieven.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Onze studenten in Amsterdam zijn opgeleid in de nieuwste technologieën en kennen de stad goed. Snel ter plaatse.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Ook 's avonds en in weekenden beschikbaar in Amsterdam. Studenten hebben flexibele schema's.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <h3 className="text-xl font-semibold text-secondary-800 mb-3">Heel Amsterdam</h3>
                <p className="text-secondary-700 leading-relaxed">
                  Van Centrum tot Noord, van Oost tot West - onze studenten komen overal in Amsterdam en omgeving.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Vaak nog dezelfde dag beschikbaar in Amsterdam. Korte reistijd betekent snelle hulp.
                </p>
              </div>
        ...
        <section className="section-spacing">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Onze Student IT Diensten in Amsterdam
              </h2>
              <p className="text-xl text-secondary-700">
                Uitgebreide computerhulp door vakkundige IT-studenten in Amsterdam
              </p>
            </div>

            <div className="grid lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-secondary-800 mb-4">🖥️ Computer & Laptop Hulp Amsterdam</h3>
              ...
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-secondary-800 mb-4">🌐 Internet & Netwerk Amsterdam</h3>
        ...
        <section className="section-spacing bg-neural-900/50">
          ...
          <div className="max-w-4xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Veelgestelde Vragen Student Aan Huis Amsterdam
              </h2>
              <p className="text-xl text-secondary-700">
                Antwoorden op de meest gestelde vragen over onze student IT service in Amsterdam
              </p>
            </div>
        ...
        {/* Amsterdam Areas Section */}
        <section className="section-spacing">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Werkgebied Amsterdam & Omgeving
              </h2>
              <p className="text-xl text-secondary-700">
                Onze IT-studenten komen naar alle wijken in en rondom Amsterdam
              </p>
            </div>

            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
              {amsterdamAreas.map((area, index) => (
            ...
            <div className="text-center">
              ...
              <Link href="/regios/amsterdam" className="btn-secondary">
        ...
        <section className="section-spacing bg-gradient-to-br from-primary-50 via-white to-accent-50">
          <div className="max-w-4xl mx-auto container-padding text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-6">
              Klaar voor Betaalbare Computerhulp in Amsterdam?
            </h2>
            <p className="text-xl text-primary-700 mb-8 max-w-2xl mx-auto">
              Onze ervaren IT-studenten in Amsterdam staan klaar om je te helpen. Snel, betaalbaar en vakkundig!
            </p>
