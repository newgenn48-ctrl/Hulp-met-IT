...
const CITY = 'Geertruidenberg'
const SLUG = 'geertruidenberg'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Geertruidenberg Centrum, Raamsdonksveer, Raamsdonk, Raamsdonksveer Centrum, Geertruidenberg Zuid, Raamsdonksveer Noord. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisGeertruidenberg() {
