...
const CITY = 'Halderberge'
const SLUG = 'halderberge'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Oudenbosch, Hoeven, Oud Gastel, Bosschenhoofd, Stampersgat, Oudenbosch Centrum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHalderberge() {
