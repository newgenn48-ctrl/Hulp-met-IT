...
const faqData = [
  ...
  },
  {
    ...
    answer: `Ja, onze studenten in ${CITY} volgen IT-opleidingen aan instellingen zoals TU Delft en Haagse Hogeschool en hebben praktijkervaring. Ze worden geselecteerd op technische én communicatieve vaardigheden. Alle studenten zijn gescreend.`
  },
  {
  ...
  },
  {
    ...
    answer: `We bedienen alle wijken van ${CITY}: Leidschendam Centrum, Voorburg, Stompwijk, plus omliggende gemeenten zoals Den Haag, Rijswijk, Wassenaar, Zoetermeer, Nootdorp, Delft, Voorschoten, Leiden en Leiderdorp.`
  },
  {
...
export default function StudentAanHuisLeidschendamVoorburgPage() {
