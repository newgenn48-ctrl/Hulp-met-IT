...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Edam, Volendam, Zeevang, Kwadijk, Oosthuizen, Warder, Hobrede. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisEdamVolendamPage() {
