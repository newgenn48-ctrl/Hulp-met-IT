...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Gouda Centrum, Gouda Noord, Gouda Oost, Gouda West, Gouda Zuid, Korte Akkeren, Oosterwei, Westergouwe, Bloemendaal, Moordrecht. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisGouda() {
