...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Beek en Donk, Aarle-Rixtel, Lieshout, Mariahout, Beek en Donk Centrum, Aarle-Rixtel Centrum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisLaarbeekPage() {
