...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Rucphen, Sprundel, Sint Willebrord, Schijf, Rucphen Centrum, Vorenseinde. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisRucphen() {
