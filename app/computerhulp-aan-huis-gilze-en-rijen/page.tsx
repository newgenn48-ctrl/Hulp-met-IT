...
const CITY = 'Gilze en Rijen'
const SLUG = 'gilze-en-rijen'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Rijen, Gilze, Molenschot, Rijen Centrum, Gilze Centrum, Hulten. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisGilzeEnRijen() {
