...
export const metadata: Metadata = {
  ...
  description: 'Student computerhulp aan huis. HBO-opgeleide ICT-studenten helpen met al uw computerproblemen. Betaalbaar, vriendelijk en vakkundig. Vanaf €15,50/kwartier.',
  keywords: [
