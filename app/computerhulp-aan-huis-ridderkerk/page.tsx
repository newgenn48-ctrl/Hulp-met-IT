...
const CITY = 'Ridderkerk'
const SLUG = 'ridderkerk'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Ridderkerk Centrum, Drievliet, Bolnes, Slikkerveer, Rijsoord, Donkersloot, Ridderkerk-West, Ridderkerk-Oost. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisRidderkerk() {
