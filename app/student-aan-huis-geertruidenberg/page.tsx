...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Geertruidenberg Centrum, Raamsdonksveer, Raamsdonk, Raamsdonksveer Centrum, Geertruidenberg Zuid, Raamsdonksveer Noord. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisGeertruidenbergPage() {
