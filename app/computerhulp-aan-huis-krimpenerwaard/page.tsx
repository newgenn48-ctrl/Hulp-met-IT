...
const CITY = 'Krimpenerwaard'
const SLUG = 'krimpenerwaard'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Schoonhoven, Bergambacht, Lekkerkerk, Haastrecht, Stolwijk, Vlist, Ammerstol, Berkenwoude, Gouderak. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisKrimpenerwaard() {
