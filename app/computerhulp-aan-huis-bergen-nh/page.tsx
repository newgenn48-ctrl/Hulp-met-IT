...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Bergen, Bergen aan Zee, Egmond aan Zee, Egmond aan den Hoef, Egmond-Binnen, Schoorl, Groet, Camperduin. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisBergenNh() {
