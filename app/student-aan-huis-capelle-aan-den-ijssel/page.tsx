...
const faqData = [
  {
    ...
    answer: `Wij rekenen €14,50 per kwartier met een minimum van 45 minuten (€43,50) plus €10 voorrijkosten. Een standaard bezoek van 45 minuten kost dus €53,50 in ${CITY}. U betaalt achteraf.`
  },
  {
    question: `Zijn de studenten wel gekwalificeerd in ${CITY}?`,
    answer: `Ja, onze studenten in ${CITY} volgen IT-opleidingen aan instellingen zoals Hogeschool Rotterdam en Erasmus Universiteit en hebben praktijkervaring. Ze worden geselecteerd op technische én communicatieve vaardigheden. Alle studenten zijn gescreend.`
  },
  {
    question: `Kunnen jullie ook 's avonds en in weekenden in ${CITY}?`,
    answer: `Ja, dat is een van onze voordelen! Studenten in ${CITY} hebben flexibele schema's. We zijn bereikbaar van 08:00 tot 22:00, 7 dagen per week.`
  },
  {
  ...
  },
  {
    ...
    answer: `We bedienen alle wijken van ${CITY}: Capelle Centrum, Schollevaar, Oostgaarde, Schenkel, Fascinatio, plus omliggende gemeenten zoals Rotterdam, Krimpen aan den IJssel, Nieuwerkerk aan den IJssel, Kralingen, Prins Alexander, Gouda en Bergschenhoek.`
  },
  {
...
export default function StudentAanHuisCapelleAanDenIJsselPage() {
