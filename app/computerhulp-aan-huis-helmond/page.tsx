...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Helmond Centrum, Helmond Noord, Helmond Oost, Helmond West, Brandevoort, Rijpelberg, Brouwhuis, Mierlo, Deurne. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHelmond() {
