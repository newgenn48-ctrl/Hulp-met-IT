...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Alblasserdam Centrum, Souburgh, Babylonienburg, Kinderdijk-omgeving, Blokweer, Alblasserdam-West. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisAlblasserdamPage() {
