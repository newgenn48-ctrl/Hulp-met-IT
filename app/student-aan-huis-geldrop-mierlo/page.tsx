...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Geldrop Centrum, Mierlo Centrum, Braakhuizen, Zesgehuchten, Skandia, Coevering, Nuenen, Heeze, Eindhoven. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisGeldropMierloPage() {
