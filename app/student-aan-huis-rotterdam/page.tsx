...
const faqData = [
  ...
  },
  {
    ...
    answer: `Ja, onze studenten in ${CITY} volgen IT-opleidingen aan instellingen zoals Erasmus Universiteit en Hogeschool Rotterdam en hebben praktijkervaring. Ze worden geselecteerd op technische én communicatieve vaardigheden. Alle studenten zijn gescreend.`
  },
  {
  ...
  },
  {
    ...
    answer: `We bedienen alle wijken van ${CITY}: Centrum, Noord, Zuid, Kralingen, Feijenoord, Delfshaven, Hillegersberg, Overschie, plus omliggende gemeenten zoals Capelle aan den IJssel, Schiedam, Vlaardingen en Barendrecht.`
  },
  {
...
export default function StudentAanHuisRotterdamPage() {
