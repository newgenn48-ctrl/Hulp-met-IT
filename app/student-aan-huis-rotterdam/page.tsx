...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Rotterdam Centrum, Rotterdam Noord, Rotterdam Oost, Rotterdam West, Rotterdam Zuid, Kralingen-Crooswijk, Hillegersberg-Schiebroek, Hoek van Holland, Capelle aan den IJssel, Schiedam. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
