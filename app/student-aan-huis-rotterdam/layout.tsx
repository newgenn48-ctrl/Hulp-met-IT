...
export const metadata: Metadata = {
  ...
  description: `ICT Student aan huis in ${CITY} voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Rotterdam Centrum, Kralingen, Hillegersberg, Feijenoord en omgeving. Vanaf €53,50. Snel, vakkundig en vriendelijk!`,
  keywords: [
  ...
  openGraph: {
    title: `ICT Student aan huis ${CITY} | Computerhulp vanaf €53,50`,
    description: `Betaalbare computerhulp door ervaren IT-studenten in ${CITY}. Wij komen bij u thuis in Rotterdam en omgeving. Vanaf €53,50.`,
