...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Oisterwijk Centrum, Moergestel, Heukelom, Oisterwijk Noord, Oisterwijk Zuid, Kerkhoven, Bedrijvenpark. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisOisterwijkPage() {
