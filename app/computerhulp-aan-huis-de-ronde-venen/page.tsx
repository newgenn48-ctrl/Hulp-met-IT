...
const CITY = 'De Ronde Venen'
const SLUG = 'de-ronde-venen'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Mijdrecht, Vinkeveen, Wilnis, Abcoude, De Hoef, Waverveen, Baambrugge. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisDeRondeVenen() {
