...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Breda Centrum, Breda Noord, Breda Oost, Breda West, Breda Zuid, Prinsenbeek, Teteringen, Oosterhout, Etten-Leur, Zundert. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisBredaPage() {
