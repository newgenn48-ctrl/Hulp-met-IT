...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Heiloo, Ypestein, Zuiderloo, Heiloo-Centrum, Heiloo-Oost, Heiloo-West. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHeiloo() {
