...
const CITY = 'Driebergen-Rijsenburg'
const SLUG = 'driebergen-rijsenburg'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Driebergen Centrum, Rijsenburg, Driebergen-Zuid, Driebergen-Noord, Doorn, Austerlitz, Zeist, Maarn. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisDriebergenRijsenburg() {
