...
const faqData = [
  ...
  },
  {
    ...
    answer: `Ja, onze studenten in ${CITY} volgen IT-opleidingen aan hogescholen en universiteiten. Ze worden geselecteerd op technische \u00E9n communicatieve vaardigheden. Alle studenten zijn gescreend.`
  },
  {
  ...
  },
  {
    ...
    answer: `We bedienen heel ${CITY} en omgeving, inclusief Bergen op Zoom Centrum, Bergen op Zoom Noord, Bergen op Zoom Oost, Bergse Plaat, Gageldonk, Halsteren en meer.`
  }
]

export default function StudentAanHuisBergenOpZoomPage() {
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: 'https://hulpmetit.nl/student-aan-huis-bergen-op-zoom'
      }
    ]
  }
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Student aan huis in Bergen op Zoom"
          fill
          priority
      ...
      <CityAboutSection citySlug="bergen-op-zoom" pageType="student" />
            ...
            <ScrollReveal>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900 mb-4">
                  Student aan huis in Bergen op Zoom en omgeving
                </h2>
              </div>
            </ScrollReveal>
      ...
      <NearbyCities currentCitySlug="bergen-op-zoom" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-bergen-op-zoom" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
