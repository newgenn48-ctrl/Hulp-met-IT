...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Bergen op Zoom Centrum, Bergen op Zoom Noord, Bergen op Zoom Oost, Bergse Plaat, Gageldonk, Halsteren, Lepelstraat, Hoogerheide. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
