...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Voorschoten Centrum, Voorschoten Noord, Voorschoten Zuid, Componistenbuurt, Krimwijk, Vlietwijk, Leidschendam, Wassenaar, Leiden. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisVoorschotenPage() {
