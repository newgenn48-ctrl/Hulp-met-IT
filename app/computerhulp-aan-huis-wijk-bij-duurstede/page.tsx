...
const CITY = 'Wijk bij Duurstede'
const SLUG = 'wijk-bij-duurstede'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Wijk bij Duurstede Centrum, De Horden, De Geer, Langbroek, Cothen, Leersum, Doorn, Amerongen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisWijkBijDuurstede() {
