...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: De Bilt Centrum, Bilthoven, Groenekan, Westbroek, Hollandsche Rading, Maartensdijk, Zeist, Utrecht. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisDeBiltPage() {
