...
const CITY = 'Goeree-Overflakkee'
const SLUG = 'goeree-overflakkee'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Middelharnis, Sommelsdijk, Ouddorp, Goedereede, Dirksland, Stellendam, Oude-Tonge, Nieuwe-Tonge, Stad aan 't Haringvliet, Ooltgensplaat. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisGoereeOverflakkee() {
