...
const CITY = 'Oegstgeest'
const SLUG = 'oegstgeest'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Oegstgeest Centrum, Haaswijk, Poelgeest, Wilhelminapark, Nieuw-Rhijngeest, Morsebel, Oudenhof. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisOegstgeest() {
