...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Etten-Leur Centrum, De Keen, Attelaken, Grauwe Polder, Bankenhoef, Schoenmakershoek, Etten-Leur Zuid, Etten-Leur Noord. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisEttenLeurPage() {
