...
const CITY = 'Wijdemeren'
const SLUG = 'wijdemeren'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Loosdrecht, Nederhorst den Berg, Kortenhoef, Ankeveen, Breukeleveen, Nieuw-Loosdrecht, Oud-Loosdrecht. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisWijdemeren() {
