...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Vught Centrum, Cromvoirt, Helvoirt, Villapark, Vught Noord, Vught Zuid, Taalstraat, Loyola. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisVught() {
