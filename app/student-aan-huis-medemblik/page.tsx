...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Medemblik, Wognum, Nibbixwoud, Opperdoes, Abbekerk, Benningbroek, Midwoud, Onderdijk. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisMedemblikPage() {
