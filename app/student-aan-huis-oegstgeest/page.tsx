...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Oegstgeest Centrum, Haaswijk, Poelgeest, Wilhelminapark, Nieuw-Rhijngeest, Morsebel, Oudenhof. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisOegstgeestPage() {
