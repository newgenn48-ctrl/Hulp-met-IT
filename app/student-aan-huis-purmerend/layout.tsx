...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Purmerend voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Purmerend Centrum, Purmerend Noord, Purmerend Zuid en omgeving. €14,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Purmerend | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Purmerend. Wij komen bij u thuis in Purmerend en omgeving. €14,50 per kwartier.',
