...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Purmerend Centrum, Purmerend Noord, Purmerend Zuid, Weidevenne, Overwhere, Wheermolen, Edam-Volendam, Monnickendam, Ilpendam, Beemster. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisPurmerendPage() {
