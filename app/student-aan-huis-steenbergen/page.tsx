...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Steenbergen Centrum, Dinteloord, Kruisland, Nieuw-Vossemeer, De Heen, Welberg. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisSteenbergenPage() {
