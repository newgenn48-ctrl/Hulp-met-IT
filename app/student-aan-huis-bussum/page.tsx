...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Bussum Centrum, Bussum Noord, Bussum Oost, Bussum West, Bussum Zuid, Brink, Naarden, Laren, Hilversum, Huizen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisBussumPage() {
