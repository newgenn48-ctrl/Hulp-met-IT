...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Wijk bij Duurstede Centrum, De Horden, De Geer, Langbroek, Cothen, Leersum, Doorn, Amerongen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisWijkBijDuurstedePage() {
