...
const CITY = 'Krimpen aan den IJssel'
const SLUG = 'krimpen-aan-den-ijssel'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Krimpen Centrum, Langeland, Oud Krimpen, Stormpolder, Laning, Kortland. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisKrimpenAanDenIjssel() {
