...
const faqData = [
  ...
  },
  {
    ...
    answer: `We bedienen heel ${CITY} en omgeving, inclusief Goes Centrum, Goes Noord, Goes Oost, Goes West, Goes Zuid, Kloetinge en meer.`
  }
]

export default function StudentAanHuisGoesPage() {
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: 'https://hulpmetit.nl/student-aan-huis-goes'
      }
    ]
  }
  ...
  return (
    <>
      ...
      <CityAboutSection citySlug="goes" pageType="student" />
            ...
            <ScrollReveal>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900 mb-4">
                  Student aan huis in Goes en omgeving
                </h2>
              </div>
            </ScrollReveal>
      ...
      <NearbyCities currentCitySlug="goes" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-goes" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
