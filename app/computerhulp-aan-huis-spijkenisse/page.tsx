...
const CITY = 'Spijkenisse'
const SLUG = 'spijkenisse'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Spijkenisse Centrum, De Akkers, Waterland, Groenewoud, Maaswijk, Vogelenzang, Hellevoetsluis, Brielle, Geervliet, Hekelingen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisSpijkenisse() {
