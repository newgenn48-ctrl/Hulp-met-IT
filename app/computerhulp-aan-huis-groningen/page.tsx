...
const processSteps = [
  {
    ...
    description: 'Bel ons of maak online een afspraak. Wij plannen een geschikt moment in Groningen'
  },
  {
    step: '2',
    title: 'Specialist Komt Langs',
    description: 'Onze vriendelijke specialist komt naar u toe in Groningen en bekijkt rustig uw probleem'
  },
  {
    step: '3',
...
const faqData = [
  {
    question: "Wat kost computerhulp aan huis in Groningen?",
    answer: "Onze computerhulp aan huis in Groningen begint vanaf €53,50 (€10 voorrijkosten + 3 x €14,50). Voor 1 uur betaalt u €69,50. Wij werken met transparante prijzen zonder verborgen kosten."
  },
  {
    question: "Hoe snel kan een specialist bij mij thuis komen in Groningen?",
    answer: "In de meeste gevallen kunnen wij binnen 24-48 uur bij u langskomen in Groningen. Voor spoedgevallen bieden wij vaak nog dezelfde dag service aan."
  },
  {
    question: "Welke computerproblemen lossen jullie op in Groningen?",
  ...
  },
  {
    ...
    answer: "Ja, wij hebben ruim 10+ jaar ervaring met computerhulp aan huis in Groningen en omgeving. Onze specialisten zijn vakkundig opgeleid en kunnen vrijwel elk computerprobleem oplossen."
  },
  {
    question: "Werken jullie ook in het weekend in Groningen?",
    answer: "Ja, wij zijn 7 dagen per week beschikbaar van 08:00 tot 21:00 uur. Ook in het weekend kunt u dus rekenen op onze computerhulp aan huis in Groningen."
  }
]
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Computerhulp aan huis Groningen",
                "item": "https://hulpmetit.nl/computerhulp-aan-huis-groningen"
              }
            ]
          })
        }}
...
<script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Hulp met IT - Computerhulp aan Huis Groningen",
            "description": "Professionele computerhulp aan huis in Groningen door ervaren specialisten",
            ...
            "serviceType": "Computerhulp aan huis Groningen"
          })
        }}
      />
      ...
      <nav aria-label="Breadcrumb" className="bg-white/50 backdrop-blur-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto container-padding py-3">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li>
              <span className="text-gray-700 font-medium">Computerhulp aan huis Groningen</span>
            </li>
          </ol>
        </div>
      </nav>
...
<div className="relative z-10 max-w-6xl mx-auto container-padding text-center flex items-center min-h-[600px] lg:min-h-[700px]">
          ...
          <h1 className="text-5xl lg:text-7xl font-bold mb-6 leading-tight">
            ...
            <br />
            <span className="text-yellow-400">Groningen</span>
          </h1>

          <p className="text-xl lg:text-2xl text-white max-w-4xl mx-auto mb-6 leading-relaxed">Zoekt u betrouwbare computerhulp aan huis in Groningen? Onze ervaren en vriendelijke specialisten komen bij u thuis en helpen u rustig en duidelijk, zodat alles weer werkt zoals het hoort.</p>
          ...
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Hoe Werkt Computerhulp aan Huis in Groningen?
              </h2>
        ...
        <section className="section-spacing bg-neural-900/30">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Waarom kiezen voor Computerhulp aan Huis Groningen?
              </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Onze specialisten hebben ruim 10 jaar ervaring met computerhulp in Groningen. Vakkundige oplossingen voor elk probleem.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Meestal binnen 24-48 uur bij u thuis in Groningen. Voor spoedgevallen vaak nog dezelfde dag beschikbaar.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Ook 's avonds en in het weekend bereikbaar in Groningen. Wij passen ons aan uw schema aan.
                </p>
              </div>
...
<div className="max-w-4xl mx-auto container-padding">
            <h2 className="text-3xl font-bold text-secondary-800 text-center mb-8">
              Computerhulp aan Huis in Heel Groningen
            </h2>
            <div className="text-center">
              <p className="text-secondary-700 text-lg leading-relaxed">
                Hulp met IT biedt computerhulp aan huis in heel Groningen. Onze vriendelijke specialisten komen naar u toe en nemen rustig de tijd om uw computerproblemen op te lossen en uit te leggen hoe alles werkt.
              </p>
            </div>

            <div className="mt-12">
              <h3 className="text-2xl font-bold text-secondary-800 text-center mb-6">
                Veelgestelde Vragen over Computerhulp aan Huis Groningen
              </h3>
