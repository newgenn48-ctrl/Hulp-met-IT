...
const benefits = [
  {
    icon: Clock,
    title: 'Snelle Hulp Groningen',
    description: 'Wij komen snel naar u toe in heel Groningen'
  },
  {
    icon: Award,
          ...
          <div className="max-w-7xl mx-auto container-padding">
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-gradient mb-6">
                ...
                <br />
                <span className="text-white">Groningen</span>
              </h1>

              <p className="text-xl text-neural-300 max-w-4xl mx-auto leading-relaxed mb-8">
                Computerhulp aan huis door vriendelijke specialisten in Groningen. Wij komen naar u toe in heel Groningen en helpen rustig bij uw computerproblemen.
