...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Groningen Centrum, Groningen Noord, Groningen Oost, Groningen West, Groningen Zuid, Paddepoel, Helpman, Vinkhuizen, Beijum, Haren. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisGroningen() {
