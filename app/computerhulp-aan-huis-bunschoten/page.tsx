...
const CITY = 'Bunschoten'
const SLUG = 'bunschoten'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Bunschoten, Spakenburg, Eemdijk, Zevenhuizen, Hoogland, Vathorst. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisBunschoten() {
