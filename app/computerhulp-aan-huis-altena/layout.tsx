...
export const metadata: Metadata = {
  ...
  description: 'Computerhulp aan huis in Altena door HBO-opgeleide ICT-studenten. Hulp in Woudrichem, Werkendam, Almkerk en omgeving. €14,50/kwartier. 7 dagen per week!',
  keywords: [
  ...
  openGraph: {
    title: 'Computerhulp aan huis Altena | Hulp met IT',
    description: 'Computerhulp aan huis in Altena door HBO-opgeleide ICT-studenten. €14,50 per kwartier + €10 voorrijkosten. Ook avond en weekend!',
  ...
  twitter: {
    ...
    title: 'Computerhulp aan huis Altena | Hulp met IT',
    description: 'Computerhulp aan huis in Altena. HBO ICT-student komt bij u thuis. €14,50/kwartier + €10 voorrijkosten.',
