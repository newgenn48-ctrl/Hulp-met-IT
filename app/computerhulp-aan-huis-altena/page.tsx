...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Woudrichem, Werkendam, Almkerk, Sleeuwijk, Dussen, Hank, Wijk en Aalburg, Veen, Andel. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisAltena() {
