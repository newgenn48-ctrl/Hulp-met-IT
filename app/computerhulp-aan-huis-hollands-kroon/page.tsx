...
const CITY = 'Hollands Kroon'
const SLUG = 'hollands-kroon'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Anna Paulowna, Wieringerwerf, Hippolytushoef, Breezand, Nieuwe Niedorp, Wieringen, Slootdorp, Kolhorn, Barsingerhorn. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHollandsKroon() {
