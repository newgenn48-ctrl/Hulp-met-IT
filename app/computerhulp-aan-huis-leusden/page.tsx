...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Leusden Centrum, Leusden-Zuid, Hamersveld, Achterveld, Stoutenburg, De Glind, Amersfoort, Woudenberg. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisLeusden() {
