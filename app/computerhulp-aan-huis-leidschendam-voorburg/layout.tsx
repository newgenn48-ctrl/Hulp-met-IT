...
export const metadata: Metadata = {
  ...
  description: 'Computerhulp aan huis in Leidschendam-Voorburg voor alle computerproblemen. IT-specialisten met 10+ jaar ervaring bij u thuis. Vanaf €53,50 voor 3 kwartier. Vandaag nog beschikbaar!',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Computerhulp aan huis in Leidschendam-Voorburg door IT-specialisten met 10+ jaar ervaring. Vanaf €53,50 voor 3 kwartier. Ook avond en weekend!',
  ...
  twitter: {
    ...
    description: 'Computerhulp aan huis Leidschendam-Voorburg. Specialist komt bij u. Vanaf €53,50 voor 3 kwartier.',
  },
  robots: {
    index: true,
    follow: true,
