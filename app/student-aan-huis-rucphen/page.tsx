...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Rucphen, Sprundel, Sint Willebrord, Schijf, Rucphen Centrum, Vorenseinde. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisRucphenPage() {
