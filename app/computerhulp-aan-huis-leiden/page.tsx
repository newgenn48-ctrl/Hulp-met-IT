...
const benefits = [
  { icon: Clock, text: 'Snelle hulp Leiden' },
      ...
      <section className="hero-section relative flex items-start justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto container-padding text-center">
          ...
          <h1 className="text-5xl lg:text-7xl font-bold mb-6 leading-tight">
            ...
            <br />
            <span className="text-secondary-800">Leiden</span>
          </h1>

          <p className="text-xl lg:text-2xl text-primary-700 max-w-4xl mx-auto mb-6 leading-relaxed">
            Computerhulp aan huis door vriendelijke specialisten in Leiden. Wij komen <span className="text-primary-700 font-semibold">binnen 24-48u</span> naar u toe en lossen het snel en vakkundig voor u op!
          </p>
