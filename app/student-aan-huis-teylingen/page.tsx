...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Sassenheim, Voorhout, Warmond, Sassenheim-Noord, Sassenheim-Zuid, Voorhout-West, Voorhout-Oost. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisTeylingenPage() {
