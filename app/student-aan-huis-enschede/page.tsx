...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Enschede Centrum, Enschede Noord, Enschede Oost, Enschede West, Enschede Zuid, Boddenkamp, Pathmos, Glanerbrug, Lonneker, Haaksbergen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisEnschedePage() {
