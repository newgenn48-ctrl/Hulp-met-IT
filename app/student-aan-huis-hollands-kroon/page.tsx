...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Anna Paulowna, Wieringerwerf, Hippolytushoef, Breezand, Nieuwe Niedorp, Wieringen, Slootdorp, Kolhorn, Barsingerhorn. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisHollandsKroonPage() {
