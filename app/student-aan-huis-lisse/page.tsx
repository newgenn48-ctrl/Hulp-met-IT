...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Lisse Centrum, Poelpolder, Meer en Dorp, Keukenhof-omgeving, Lisserbroek, Heereweg-gebied. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisLissePage() {
