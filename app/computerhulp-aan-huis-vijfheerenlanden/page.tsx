...
const CITY = 'Vijfheerenlanden'
const SLUG = 'vijfheerenlanden'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Vianen, Leerdam, Meerkerk, Lexmond, Hagestein, Everdingen, Ameide, Nieuwland, Ossenwaard. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisVijfheerenlanden() {
