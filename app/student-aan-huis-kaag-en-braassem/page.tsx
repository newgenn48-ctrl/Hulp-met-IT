...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Roelofarendsveen, Oude Wetering, Leimuiden, Rijnsaterwoude, Kaag, Bilderdam, Hoogmade, Woubrugge. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisKaagEnBraassemPage() {
