...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Kaag en Braassem voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Roelofarendsveen, Oude Wetering, Leimuiden en omgeving. €15,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Kaag en Braassem | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Kaag en Braassem. Wij komen bij u thuis in Kaag en Braassem en omgeving. €15,50 per kwartier.',
