...
const faqData = [
  {
    ...
    answer: "Onze computerhulp aan huis in Tilburg kost €14,50 per kwartier, met een minimum van 3 kwartier. Voorrijkosten zijn €10 eenmalig. U betaalt achteraf."
  },
  {
    question: "Hoe snel kan een student bij mij thuis komen in Tilburg?",
  ...
  },
  {
    ...
    answer: "Ja, wij hebben ruime ervaring met computerhulp aan huis in Tilburg en omgeving. Onze studenten zijn HBO-opgeleid en kunnen vrijwel elk computerprobleem oplossen."
  },
  {
...
export default function ComputerhulpAanHuisTilburg() {
  ...
  const localBusinessStructuredData = {
    ...
    description: 'Professionele computerhulp aan huis in Tilburg door HBO-opgeleide ICT-studenten',
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Computerhulp aan huis in Tilburg"
          fill
          priority
          ...
          <div className="max-w-2xl">
            <ScrollReveal>
              ...
              <h1 className="text-4xl sm:text-5xl xl:text-6xl font-extrabold text-white leading-[1.1] mb-6">
                Computerhulp{' '}
                <span className="text-accent-400">aan huis in Tilburg</span>
              </h1>

              <p className="text-lg text-white/80 leading-relaxed mb-8 max-w-lg">
                Een HBO-opgeleide student komt bij u thuis in Tilburg, lost het probleem op en legt alles uit in gewone taal. Zo kunt u er weer tegenaan.
              </p>
      ...
      <CityAboutSection citySlug="tilburg" pageType="computerhulp" />
            ...
            <ScrollReveal delay={300}>
              <div className="text-center">
                <p className="text-secondary-500 text-lg leading-relaxed max-w-3xl mx-auto">
                  Hulp met IT biedt computerhulp aan huis in heel Tilburg. onze vriendelijke studenten komen naar u toe en helpen u rustig en geduldig met uw computerproblemen en leggen alles uit.
                </p>
              </div>
            </ScrollReveal>
          </div>
      ...
      <NearbyCities currentCitySlug="tilburg" pageType="computerhulp" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/student-aan-huis-tilburg" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
