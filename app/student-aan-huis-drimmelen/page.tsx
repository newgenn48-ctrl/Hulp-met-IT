...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Made, Terheijden, Lage Zwaluwe, Hooge Zwaluwe, Wagenberg, Drimmelen dorp. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisDrimmelenPage() {
