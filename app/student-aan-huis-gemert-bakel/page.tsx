...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Gemert, Bakel, De Mortel, Elsendorp, De Rips, Handel, Milheeze. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisGemertBakelPage() {
