...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Veenendaal Centrum, Veenendaal Noord, Veenendaal Oost, Veenendaal West, Dragonder, De Engelenburg, French Lick, Rhenen, Renswoude, Ede. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisVeenendaalPage() {
