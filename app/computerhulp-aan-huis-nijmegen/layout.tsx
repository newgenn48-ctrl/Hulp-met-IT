...
export const metadata: Metadata = {
  ...
  description: 'Computerhulp aan huis in Nijmegen door HBO-opgeleide ICT-studenten. Hulp in Nijmegen Centrum, Nijmegen Noord, Nijmegen Oost en omgeving. €14,50/kwartier. 7 dagen per week!',
  keywords: [
  ...
  twitter: {
    ...
    title: 'Computerhulp aan huis Nijmegen | Hulp met IT',
    description: 'Computerhulp aan huis in Nijmegen. HBO ICT-student komt bij u thuis. €14,50/kwartier + €10 voorrijkosten.',
