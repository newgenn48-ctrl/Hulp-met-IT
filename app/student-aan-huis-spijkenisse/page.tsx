...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Spijkenisse Centrum, De Akkers, Waterland, Groenewoud, Maaswijk, Vogelenzang, Hellevoetsluis, Brielle, Geervliet, Hekelingen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisSpijkenissePage() {
