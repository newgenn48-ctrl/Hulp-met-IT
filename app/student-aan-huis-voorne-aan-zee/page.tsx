...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Hellevoetsluis, Brielle, Rockanje, Oostvoorne, Vierpolders, Zwartewaal, Nieuwenhoorn, Tinte. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisVoorneAanZeePage() {
