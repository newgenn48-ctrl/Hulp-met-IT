...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Groningen voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Groningen Centrum, Groningen Noord, Groningen Oost en omgeving. €15,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Groningen | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Groningen. Wij komen bij u thuis in Groningen en omgeving. €15,50 per kwartier.',
