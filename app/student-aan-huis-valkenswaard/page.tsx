...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Valkenswaard Centrum, Dommelen, Borkel en Schaft, Geenhoven, Lage Heide, De Belleman, Het Gegraaf. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisValkenswaardPage() {
