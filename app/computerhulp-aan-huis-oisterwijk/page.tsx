...
const CITY = 'Oisterwijk'
const SLUG = 'oisterwijk'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Oisterwijk Centrum, Moergestel, Heukelom, Oisterwijk Noord, Oisterwijk Zuid, Kerkhoven, Bedrijvenpark. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisOisterwijk() {
