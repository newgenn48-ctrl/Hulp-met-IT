...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Someren Centrum, Someren-Eind, Someren-Heide, Lierop, Someren Noord, Someren Zuid. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisSomeren() {
