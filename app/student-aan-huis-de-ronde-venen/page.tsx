...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Mijdrecht, Vinkeveen, Wilnis, Abcoude, De Hoef, Waverveen, Baambrugge. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisDeRondeVenenPage() {
