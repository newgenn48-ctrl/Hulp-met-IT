...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Zwijndrecht Centrum, Walburg, Nederhoven, Ontwikkeling, Kort Ambacht, Heer Oudelands Ambacht, Groote Lindt. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisZwijndrechtPage() {
