...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Someren Centrum, Someren-Eind, Someren-Heide, Lierop, Someren Noord, Someren Zuid. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisSomerenPage() {
