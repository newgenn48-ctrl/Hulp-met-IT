...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Someren voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Someren Centrum, Someren-Eind, Someren-Heide en omgeving. €15,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Someren | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Someren. Wij komen bij u thuis in Someren en omgeving. €15,50 per kwartier.',
