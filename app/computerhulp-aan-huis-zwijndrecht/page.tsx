...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Zwijndrecht Centrum, Walburg, Nederhoven, Ontwikkeling, Kort Ambacht, Heer Oudelands Ambacht, Groote Lindt. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisZwijndrecht() {
