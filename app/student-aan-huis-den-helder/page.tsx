...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Den Helder Centrum, Nieuw-Den Helder, De Schooten, Julianadorp, Huisduinen, Van Foreestbuurt, Texel, Schagen, Anna Paulowna. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisDenHelderPage() {
