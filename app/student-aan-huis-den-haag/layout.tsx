...
export const metadata: Metadata = {
  title: 'ICT Student aan huis Den Haag | Computerhulp vanaf €53,50',
  ...
  openGraph: {
    ...
    description: 'Betaalbare computerhulp door IT-studenten in Den Haag. Vanaf €53,50. Snel ter plaatse!',
