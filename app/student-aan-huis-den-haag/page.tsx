...
const areas = [
  'Den Haag Centrum', 'Scheveningen', 'Loosduinen', 'Laak',
  'Haagse Hout', 'Escamp', 'Segbroek', 'Leidschenveen-Ypenburg',
  'Rijswijk', 'Voorburg', 'Wassenaar', 'Delft'
]
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Ja, onze studenten in ${CITY} volgen IT-opleidingen aan de Haagse Hogeschool en TU Delft. Ze worden geselecteerd op technische én communicatieve vaardigheden. Alle studenten zijn gescreend.`
  },
  {
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Student aan huis in Den Haag"
          fill
          priority
      ...
      <CityAboutSection citySlug="den-haag" pageType="student" />
      ...
      <NearbyCities currentCitySlug="den-haag" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-den-haag" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
