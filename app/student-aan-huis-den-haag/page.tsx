...
const denHaagAreas = [
  'Den Haag Centrum', 'Scheveningen', 'Benoordenhout', 'Haagse Bos',
  'Laak', 'Escamp', 'Segbroek', 'Leidschenveen-Ypenburg',
  'Loosduinen', 'Voorburg', 'Wassenaar', 'Rijswijk'
]
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Betaalbare computerhulp in Den Haag door ervaren IT-studenten",
          ...
          <div className="max-w-7xl mx-auto container-padding">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-neural-300 max-w-4xl mx-auto leading-relaxed mb-8">
                Computerproblemen in Den Haag? Onze IT-studenten komen naar je toe! Betaalbare hulp door lokale studenten. 
