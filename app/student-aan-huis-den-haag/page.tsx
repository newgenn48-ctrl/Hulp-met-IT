...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Den Haag Centrum, Scheveningen, Benoordenhout, Haagse Bos, Laak, Escamp, Segbroek, Leidschenveen-Ypenburg, Loosduinen, Voorburg. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisDenHaagPage() {
