...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Hoorn voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Hoorn Centrum, Hoorn Noord, Kersenboogerd en omgeving. €14,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Hoorn | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Hoorn. Wij komen bij u thuis in Hoorn en omgeving. €14,50 per kwartier.',
