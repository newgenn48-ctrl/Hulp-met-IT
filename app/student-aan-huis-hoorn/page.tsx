...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Hoorn Centrum, Hoorn Noord, Kersenboogerd, Risdam, Grote Waal, Blokker, Zwaag, Enkhuizen, Medemblik. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisHoornPage() {
