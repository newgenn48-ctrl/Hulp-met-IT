...
const CITY = 'Woensdrecht'
const SLUG = 'woensdrecht'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Hoogerheide, Huijbergen, Putte, Ossendrecht, Woensdrecht dorp, Calfven, Hoogerheide Centrum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisWoensdrecht() {
