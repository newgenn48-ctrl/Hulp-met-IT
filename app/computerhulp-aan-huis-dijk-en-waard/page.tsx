...
const CITY = 'Dijk en Waard'
const SLUG = 'dijk-en-waard'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Heerhugowaard, Langedijk, Sint Pancras, Noord-Scharwoude, Zuid-Scharwoude, Broek op Langedijk, Heerhugowaard-Zuid, Heerhugowaard-Noord, De Noord. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisDijkEnWaard() {
