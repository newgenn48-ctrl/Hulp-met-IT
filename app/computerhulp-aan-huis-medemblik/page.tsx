...
const CITY = 'Medemblik'
const SLUG = 'medemblik'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Medemblik, Wognum, Nibbixwoud, Opperdoes, Abbekerk, Benningbroek, Midwoud, Onderdijk. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisMedemblik() {
