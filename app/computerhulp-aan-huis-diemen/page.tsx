...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Diemen-Noord, Diemen-Zuid, Diemen-Centrum, Holland Park, Plantage de Sniep, Buitenlust, Stammerdijk. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisDiemen() {
