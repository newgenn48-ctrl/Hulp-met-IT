...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Oss Centrum, Oss Noord, Oss Oost, Oss West, Ussen, Ruwaard, Berghem, Heesch, Ravenstein. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisOss() {
