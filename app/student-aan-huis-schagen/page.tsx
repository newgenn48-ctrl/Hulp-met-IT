...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Schagen, Tuitjenhorn, Warmenhuizen, Dirkshorn, Callantsoog, Sint Maartensbrug, Petten, Schagerbrug. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisSchagenPage() {
