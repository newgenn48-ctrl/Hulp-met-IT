...
const areas = [
  'Zoetermeer Centrum', 'Rokkeveen', 'Meerzicht', 'Seghwaert',
  'Buytenwegh', 'Palenstein', 'Bleiswijk', 'Berkel en Rodenrijs',
  'Pijnacker', 'Nootdorp', 'Benthuizen', 'Moerkapelle'
]
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Ja, onze studenten in ${CITY} volgen IT-opleidingen aan TU Delft en Haagse Hogeschool. Ze worden geselecteerd op technische én communicatieve vaardigheden. Alle studenten zijn gescreend.`
  },
  {
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Student aan huis in Zoetermeer"
          fill
          priority
      ...
      <CityAboutSection citySlug="zoetermeer" pageType="student" />
      ...
      <NearbyCities currentCitySlug="zoetermeer" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-zoetermeer" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
