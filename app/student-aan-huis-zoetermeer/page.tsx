...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Zoetermeer Centrum, Zoetermeer Noord, Zoetermeer Oost, Zoetermeer West, Zoetermeer Zuid, Oosterheem, Driemanspolder, Palenstein, Rokkeveen, Meerzicht. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisZoetermeerPage() {
