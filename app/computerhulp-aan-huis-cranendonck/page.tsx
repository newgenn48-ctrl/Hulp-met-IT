...
const CITY = 'Cranendonck'
const SLUG = 'cranendonck'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Budel, Maarheeze, Budel-Schoot, Budel-Dorplein, Gastel, Soerendonk, Budel Centrum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisCranendonck() {
