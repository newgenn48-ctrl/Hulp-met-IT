...
const CITY = 'Stichtse Vecht'
const SLUG = 'stichtse-vecht'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Maarssen, Breukelen, Loenen aan de Vecht, Nieuwersluis, Nigtevecht, Oud-Zuilen, Tienhoven, Vreeland. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisStichtseVecht() {
