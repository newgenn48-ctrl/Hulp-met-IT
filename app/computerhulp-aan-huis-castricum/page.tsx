...
const CITY = 'Castricum'
const SLUG = 'castricum'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Castricum, Limmen, Akersloot, Bakkum, De Woude, Castricum-Oost. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisCastricum() {
