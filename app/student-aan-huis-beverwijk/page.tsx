...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Beverwijk, Wijk aan Zee, Westerhout, Beverwijk-Zuid, Beverwijk-Oost, Meerestein. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisBeverwijkPage() {
