...
const faqData = [
  {
    ...
    answer: "Onze tarieven beginnen vanaf €13,99 per kwartier in Den Bosch. Dit is veel voordeliger dan traditionele computerhulp services. Je betaalt alleen voor de daadwerkelijk bestede tijd, geen voorrijkosten of minimumtarief."
  },
  {
          ...
          <div className="max-w-7xl mx-auto container-padding">
            <div className="text-center mb-8">
              <div className="inline-flex items-center bg-blue-500/20 text-blue-400 px-4 py-2 rounded-full text-sm font-medium mb-6">
                ...
                Student Aan Huis Service Den Bosch
              </div>
              ...
              <p className="text-xl text-neural-300 max-w-4xl mx-auto leading-relaxed mb-8">
                Computerproblemen in Den Bosch? Onze IT-studenten komen naar je toe! Betaalbare hulp door lokale studenten. 
        ...
        <section className="section-spacing bg-neural-900/30">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
                Waarom kiezen voor onze Student Aan Huis in Den Bosch?
              </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="glass-effect rounded-lg p-6">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">Betaalbare Tarieven Den Bosch</h3>
                <p className="text-neural-300 leading-relaxed">
                  Vanaf €13,99 per kwartier in Den Bosch - veel goedkoper dan traditionele computerhulp. Perfecte kwaliteit tegen studententarieven.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">Heel Den Bosch</h3>
                <p className="text-neural-300 leading-relaxed">
          ...
          <div className="max-w-6xl mx-auto container-padding">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-white mb-4">🖥️ Computer & Laptop Hulp Den Bosch</h3>
              ...
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-white mb-4">🌐 Internet & Netwerk Den Bosch</h3>
