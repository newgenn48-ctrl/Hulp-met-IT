...
const processSteps = [
  {
    step: '1',
    title: 'Plan Afspraak',
    description: 'Bel of plan online - binnen Den Bosch snel beschikbaar'
  },
  {
    step: '2', 
    title: 'Student Komt Langs',
    description: 'IT-student komt naar je adres in Den Bosch'
  },
  {
    step: '3',
...
const denBoschAreas = [
  'Den Bosch Centrum', 'Den Bosch Noord', 'Den Bosch Oost', 'Den Bosch West',
  'Den Bosch Zuid', 'Maaspoort', 'Rosmalen', 'Vught',
  'Sint-Michielsgestel', 'Boxtel', 'Schijndel', 'Veghel'
]

const faqData = [
  {
    question: "Wat kost student aan huis hulp in Den Bosch?",
    answer: "Onze tarieven beginnen vanaf €14,50 per kwartier in Den Bosch. Dit is veel voordeliger dan traditionele computerhulp services. Je betaalt alleen voor de daadwerkelijk bestede tijd, geen voorrijkosten of minimumtarief."
  },
  {
    question: "Zijn jullie studenten wel gekwalificeerd in Den Bosch?",
    answer: "Ja, onze studenten in Den Bosch volgen IT-opleidingen en hebben praktijkervaring. Ze zijn vertrouwd met moderne technologie en worden geselecteerd op hun technische vaardigheden en communicatieve vaardigheden."
  },
  {
    question: "Kunnen jullie ook 's avonds en weekenden komen in Den Bosch?",
    answer: "Ja, dat is een van onze grote voordelen! Onze studenten in Den Bosch hebben flexibele schema's en kunnen vaak ook 's avonds en in weekenden. We zijn bereikbaar van 08:00 tot 22:00, 7 dagen per week."
  },
  {
    question: "Hoe snel kunnen jullie komen in Den Bosch?",
    answer: "In Den Bosch kunnen we vaak nog dezelfde dag langskomen, vooral 's avonds en in weekenden. Voor urgent problemen proberen we binnen 2-4 uur beschikbaar te zijn in het centrum en omliggende wijken."
  },
  {
    question: "Welke wijken in Den Bosch bedienen jullie?",
    answer: "We bedienen alle wijken van Den Bosch: Centrum, Noord, Oost, West, Zuid, Maaspoort, Rosmalen, plus omliggende gemeenten zoals Vught, Boxtel en Sint-Michielsgestel."
  }
]
...
export default function StudentAanHuisDenBoschLanding() {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Hulp met IT - Student Aan Huis Den Bosch",
            "description": "Betaalbare computerhulp in Den Bosch door ervaren IT-studenten. Historische Brabantse hoofdstad.",
            ...
            "offers": {
              "@type": "Offer",
              "description": "Computerhulp door IT-studenten in Den Bosch",
              "price": "13.99",
              "priceCurrency": "EUR",
      ...
      <div className="relative">
          ...
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Hoe Werkt Student Aan Huis in Den Bosch?
              </h2>
              <p className="text-xl text-secondary-700">
                Snel, lokaal en betaalbaar - vakkundige hulp in Den Bosch
              </p>
            </div>
        ...
        <section className="section-spacing bg-neural-900/30">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Waarom Kiezen Voor Student Aan Huis Den Bosch?
              </h2>
              <p className="text-xl text-secondary-700 max-w-3xl mx-auto">
                Ontdek de voordelen van computerhulp door ervaren IT-studenten in Den Bosch
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Vanaf €14,50 per kwartier in Den Bosch - veel goedkoper dan traditionele computerhulp. Perfecte kwaliteit tegen studententarieven.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Onze studenten in Den Bosch zijn opgeleid in de nieuwste technologieën en kennen de historische stad goed. Van centrum tot Rosmalen.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Ook 's avonds en in weekenden beschikbaar in Den Bosch. Studenten hebben flexibele schema's die perfect aansluiten bij uw behoeften.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <h3 className="text-xl font-semibold text-secondary-800 mb-3">Heel Den Bosch</h3>
                <p className="text-secondary-700 leading-relaxed">
                  Van historisch Centrum tot Maaspoort, van Noord tot Zuid - onze studenten komen overal in Den Bosch en omgeving zoals Vught.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Vaak nog dezelfde dag beschikbaar in Den Bosch. Korte reistijd betekent snelle hulp en lagere kosten.
                </p>
              </div>
        ...
        <section className="section-spacing">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Onze Student IT Diensten in Den Bosch
              </h2>
              <p className="text-xl text-secondary-700">
                Uitgebreide computerhulp door vakkundige IT-studenten in Den Bosch
              </p>
            </div>

            <div className="grid lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-secondary-800 mb-4">🖥️ Computer & Laptop Hulp Den Bosch</h3>
              ...
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-secondary-800 mb-4">🌐 Internet & Netwerk Den Bosch</h3>
        ...
        <section className="section-spacing bg-neural-900/50">
          <div className="max-w-4xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Veelgestelde Vragen Student Aan Huis Den Bosch
              </h2>
              <p className="text-xl text-secondary-700">
                Antwoorden op de meest gestelde vragen over onze student IT service in Den Bosch
              </p>
            </div>
        ...
        {/* Den Bosch Areas Section */}
        <section className="section-spacing">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Werkgebied Den Bosch & Omgeving
              </h2>
              <p className="text-xl text-secondary-700">
                Onze IT-studenten komen naar alle wijken in en rondom Den Bosch
              </p>
            </div>

            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
              {denBoschAreas.map((area, index) => (
            ...
            <div className="text-center">
              ...
              <Link href="/regios/den-bosch" className="btn-secondary">
        ...
        <section className="section-spacing bg-gradient-to-br from-primary-50 via-white to-accent-50">
          <div className="max-w-4xl mx-auto container-padding text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-6">
              Klaar voor Betaalbare Computerhulp in Den Bosch?
            </h2>
            <p className="text-xl text-primary-700 mb-8 max-w-2xl mx-auto">
              Onze ervaren IT-studenten in Den Bosch staan klaar om je te helpen. Snel, betaalbaar en vakkundig!
            </p>
