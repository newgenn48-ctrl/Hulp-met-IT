...
export default function StudentAanHuisCityPage() {
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: `ICT Student aan Huis ${CITY_CASUAL}`,
  ...
  const serviceStructuredData = {
    ...
    '@type': 'Service',
    name: `ICT Student aan Huis ${CITY_CASUAL}`,
    description: `Betaalbare computerhulp door ervaren IT-studenten aan huis in ${CITY_CASUAL}`,
    provider: {
      '@type': 'LocalBusiness',
      name: 'Hulp met IT',
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Student aan huis in Den Bosch"
          fill
          priority
          ...
          <div className="max-w-2xl">
            <ScrollReveal>
              ...
              <h1 className="text-4xl sm:text-5xl xl:text-6xl font-extrabold text-white leading-[1.1] mb-6">
                Student aan huis{' '}
                <span className="text-accent-400">in {CITY_CASUAL}</span>
              </h1>

              <p className="text-lg text-white/80 leading-relaxed mb-8 max-w-lg">
                Een HBO-opgeleide student komt bij u thuis in {CITY_CASUAL}, lost het probleem op en legt alles uit in gewone taal. Zo kunt u er weer tegenaan.
              </p>
      ...
      <CityAboutSection citySlug="den-bosch" pageType="student" />
      ...
      <NearbyCities currentCitySlug="den-bosch" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-den-bosch" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
