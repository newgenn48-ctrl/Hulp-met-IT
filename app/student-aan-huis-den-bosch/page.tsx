...
const CITY = "'s-Hertogenbosch"
const CITY_CASUAL = 'Den Bosch'
...
const benefits = [
  ...
  },
  {
    icon: GraduationCap,
    title: 'IT-Studenten',
    description: 'Studenten van Avans Hogeschool en HAS Hogeschool, vertrouwd met moderne systemen.'
  },
  {
    icon: Clock,
...
const processSteps = [
  {
    ...
    description: `Vertel ons kort wat het probleem is. Wij plannen een afspraak op een moment dat u uitkomt in ${CITY_CASUAL}.`
  },
  {
    title: 'Student komt langs',
    description: `Een ervaren IT-student komt bij u thuis in ${CITY_CASUAL} met alle benodigde tools en kennis.`
  },
  {
...
const areas = [
  'Den Bosch Centrum', 'Rosmalen', 'Vught', 'Sint-Michielsgestel',
  'Berlicum', 'Den Dungen', 'Nuland', 'Vinkel',
  'Empel', 'Engelen', 'Bokhoven', 'Maaspoort'
]

const faqData = [
  {
    question: `Wat kost ICT student aan huis hulp in ${CITY_CASUAL}?`,
  ...
  {
    question: `Zijn de studenten wel gekwalificeerd in ${CITY_CASUAL}?`,
    answer: `Ja, onze studenten in ${CITY_CASUAL} volgen IT-opleidingen aan Avans Hogeschool en HAS Hogeschool. Ze worden geselecteerd op technische en communicatieve vaardigheden. Alle studenten zijn gescreend.`
  },
  {
    question: `Kunnen jullie ook 's avonds en in weekenden in ${CITY_CASUAL}?`,
    answer: `Ja, dat is een van onze voordelen! Studenten hebben flexibele schema's. We zijn bereikbaar van 08:00 tot 22:00, 7 dagen per week in ${CITY_CASUAL}.`
  },
  {
    question: `Hoe snel kunnen jullie komen in ${CITY_CASUAL}?`,
    answer: `Vaak kunnen we nog dezelfde dag langskomen in ${CITY_CASUAL}. Voor urgente problemen proberen we binnen enkele uren beschikbaar te zijn.`
  },
  {
    question: `Welke gebieden in ${CITY_CASUAL} bedienen jullie?`,
    answer: `We bedienen heel ${CITY} en omgeving, inclusief ${areas.slice(0, 6).join(', ')} en meer.`
  }
]

export default function StudentAanHuisDenBoschPage() {
      ...
      <div className="bg-secondary-50 border-b border-secondary-200">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 py-3">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-secondary-400">/</span>
            <span className="text-secondary-700 font-medium">{CITY_CASUAL}</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl xl:text-6xl font-bold text-secondary-900 leading-tight mb-6">
                ICT Student
                <span className="text-primary-700"> aan huis {CITY_CASUAL}</span>
              </h1>

              {/* Subtitel */}
              <p className="text-xl text-secondary-600 leading-relaxed mb-4 max-w-lg">
                Betaalbare computerhulp door ervaren IT-studenten in {CITY_CASUAL}. Snel, vakkundig en vriendelijk bij u thuis.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
                <Image
                  ...
                  alt={`IT-student helpt klant thuis met computer in ${CITY_CASUAL}`}
                  fill
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900 mb-4">
              Voordelen van ICT student aan huis in {CITY_CASUAL}
            </h2>
          </div>
      ...
      <section className="py-16 lg:py-20 bg-secondary-50">
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900 mb-4">
              In 4 stappen geholpen in {CITY_CASUAL}
            </h2>
          </div>
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900 mb-4">
              ICT Student aan huis in {CITY_CASUAL} en omgeving
            </h2>
          </div>
      ...
      <section className="py-16 lg:py-20 bg-secondary-50">
        <div className="max-w-3xl mx-auto px-6 sm:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900 mb-4">
              Vragen over ICT student aan huis in {CITY_CASUAL}
            </h2>
          </div>
      ...
      <section className="py-16 lg:py-20 bg-gradient-to-r from-primary-500 to-primary-600">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
            Klaar voor computerhulp in {CITY_CASUAL}?
          </h2>
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Onze ervaren IT-studenten in {CITY_CASUAL} staan klaar om u te helpen. Snel, vakkundig en betaalbaar.
          </p>
