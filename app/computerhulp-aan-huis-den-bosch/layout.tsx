...
export const metadata: Metadata = {
  ...
  description: 'Computerhulp aan huis in Den Bosch door HBO-opgeleide ICT-studenten. Hulp in Den Bosch Centrum, Den Bosch Noord, Den Bosch Oost en omgeving. €14,50/kwartier. 7 dagen per week!',
  keywords: [
  ...
  twitter: {
    ...
    title: 'Computerhulp aan huis Den Bosch | Hulp met IT',
    description: 'Computerhulp aan huis in Den Bosch. HBO ICT-student komt bij u thuis. €14,50/kwartier + €10 voorrijkosten.',
