...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Naarden Centrum, Naarden Noord, Naarden Oost, Naarden West, Naarden Zuid, Naarden Vesting, Bussum, Huizen, Weesp, Hilversum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisNaardenPage() {
