...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Aalsmeer, Kudelstaart, Aalsmeer-Oost, Aalsmeer-West, Hornmeer, Stommeer. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisAalsmeer() {
