...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Oudenbosch, Hoeven, Oud Gastel, Bosschenhoofd, Stampersgat, Oudenbosch Centrum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisHalderbergePage() {
