...
const CITY = 'Etten-Leur'
const SLUG = 'etten-leur'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Etten-Leur Centrum, De Keen, Attelaken, Grauwe Polder, Bankenhoef, Schoenmakershoek, Etten-Leur Zuid, Etten-Leur Noord. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisEttenLeur() {
