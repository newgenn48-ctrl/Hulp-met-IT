...
const CITY = 'Gemert-Bakel'
const SLUG = 'gemert-bakel'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Gemert, Bakel, De Mortel, Elsendorp, De Rips, Handel, Milheeze. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisGemertBakel() {
