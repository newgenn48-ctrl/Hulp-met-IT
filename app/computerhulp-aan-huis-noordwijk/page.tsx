...
const CITY = 'Noordwijk'
const SLUG = 'noordwijk'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Noordwijk aan Zee, Noordwijk-Binnen, Noordwijkerhout, De Zilk, Langeveld, Offem, Boechorst. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisNoordwijk() {
