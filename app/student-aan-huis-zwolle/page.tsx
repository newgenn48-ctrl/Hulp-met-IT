...
const faqData = [
  {
    ...
    answer: "Onze tarieven beginnen vanaf €14,50 per kwartier in Zwolle. Dit is veel voordeliger dan traditionele computerhulp services. Je betaalt alleen voor de daadwerkelijk bestede tijd, geen voorrijkosten of minimumtarief."
  },
  {
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Vanaf €14,50 per kwartier in Zwolle - veel goedkoper dan traditionele computerhulp. Perfecte kwaliteit tegen studententarieven.
                </p>
              </div>
