...
const CITY = 'Nieuwegein'
const SLUG = 'nieuwegein'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Nieuwegein Centrum, Batau, Galecop, Vreeswijk, Jutphaas, Doorslag, Fokkesteeg, IJsselstein, Vianen, Houten. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisNieuwegein() {
