...
const CITY = 'Voorschoten'
const SLUG = 'voorschoten'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Voorschoten Centrum, Voorschoten Noord, Voorschoten Zuid, Componistenbuurt, Krimwijk, Vlietwijk, Leidschendam, Wassenaar, Leiden. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisVoorschoten() {
