...
const CITY = 'Bodegraven-Reeuwijk'
const SLUG = 'bodegraven-reeuwijk'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Bodegraven, Reeuwijk-Dorp, Reeuwijk-Brug, Nieuwerbrug, Driebruggen, Waarder, Tempel. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisBodegravenReeuwijk() {
