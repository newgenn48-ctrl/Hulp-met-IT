...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const metaDescription = service.metaDescription || `${service.description} ✓ Transparante tarieven €15,50 per kwartier ✓ Binnen 48 uur geholpen ✓ HBO-opgeleide studenten`
