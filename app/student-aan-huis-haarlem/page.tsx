...
const areas = [
  'Haarlem Centrum', 'Haarlem Noord', 'Haarlem Zuid', 'Haarlem Oost',
  'Schalkwijk', 'Heemstede', 'Bloemendaal', 'Zandvoort',
  'Hoofddorp', 'Nieuw-Vennep', 'Bennebroek', 'Hillegom'
]
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Ja, onze studenten in ${CITY} volgen IT-opleidingen aan onder andere Inholland Hogeschool. Ze worden geselecteerd op technische en communicatieve vaardigheden. Alle studenten zijn gescreend.`
  },
  {
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Student aan huis in Haarlem"
          fill
          priority
      ...
      <CityAboutSection citySlug="haarlem" pageType="student" />
      ...
      <NearbyCities currentCitySlug="haarlem" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-haarlem" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
