...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Haarlem Centrum, Haarlem Noord, Haarlem Oost, Haarlem Zuid, Schalkwijk, Botermarkt, Grote Markt gebied, Spaarndam, Bloemendaal, Heemstede. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisHaarlemPage() {
