...
export const metadata: Metadata = {
  ...
  description: 'Computerhulp aan huis in Laren voor alle computerproblemen. IT-specialisten met 10+ jaar ervaring bij u thuis. €14,50 per kwartier + €10 voorrijkosten. Vandaag nog beschikbaar!',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Computerhulp aan huis in Laren door IT-specialisten met 10+ jaar ervaring. €14,50 per kwartier + €10 voorrijkosten. Ook avond en weekend!',
  ...
  twitter: {
    ...
    description: 'Computerhulp aan huis Laren. Specialist komt bij u. €14,50 per kwartier + €10 voorrijkosten.',
  },
  robots: {
    index: true,
    follow: true,
