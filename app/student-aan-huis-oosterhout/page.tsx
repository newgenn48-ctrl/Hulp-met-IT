...
const faqData = [
  ...
  },
  {
    ...
    answer: `We bedienen heel ${CITY} en omgeving, inclusief Oosterhout Centrum, Oosterhout Noord, Oosterhout Oost, Slotjes, Vrachelen, Dommelbergen en meer.`
  }
]

export default function StudentAanHuisOosterhoutPage() {
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: 'https://hulpmetit.nl/student-aan-huis-oosterhout'
      }
    ]
  }
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Student aan huis in Oosterhout"
          fill
          priority
      ...
      <CityAboutSection citySlug="oosterhout" pageType="student" />
            ...
            <ScrollReveal>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900 mb-4">
                  Student aan huis in Oosterhout en omgeving
                </h2>
              </div>
            </ScrollReveal>
      ...
      <NearbyCities currentCitySlug="oosterhout" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-oosterhout" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
