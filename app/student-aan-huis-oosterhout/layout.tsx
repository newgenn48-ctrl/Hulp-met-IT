...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Oosterhout voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Oosterhout Centrum, Oosterhout Noord, Oosterhout Oost en omgeving. €14,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Oosterhout | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Oosterhout. Wij komen bij u thuis in Oosterhout en omgeving. €14,50 per kwartier.',
