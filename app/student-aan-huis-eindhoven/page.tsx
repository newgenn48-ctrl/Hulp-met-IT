...
const areas = [
  ...
  'Stratum', 'Gestel', 'Veldhoven', 'Best',
  'Son en Breugel', 'Nuenen', 'Geldrop', 'Helmond'
]
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Ja, onze studenten in ${CITY} volgen IT-opleidingen aan TU Eindhoven en Fontys Hogescholen. Ze worden geselecteerd op technische en communicatieve vaardigheden. Alle studenten zijn gescreend.`
  },
  {
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Student aan huis in Eindhoven"
          fill
          priority
      ...
      <CityAboutSection citySlug="eindhoven" pageType="student" />
      ...
      <NearbyCities currentCitySlug="eindhoven" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-eindhoven" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
