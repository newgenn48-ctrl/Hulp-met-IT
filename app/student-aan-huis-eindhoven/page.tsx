...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Eindhoven Centrum, Woensel Noord, Woensel Zuid, Stratum, Gestel, Strijp, Tongelre, Veldhoven, Geldrop, Nuenen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisEindhovenPage() {
