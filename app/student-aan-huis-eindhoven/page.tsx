...
const eindhovenAreas = [
  'Eindhoven Centrum', 'Woensel Noord', 'Woensel Zuid', 'Stratum',
  'Gestel', 'Strijp', 'Tongelre', 'Veldhoven',
  'Geldrop', 'Nuenen', 'Best', 'Son en Breugel'
]
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Betaalbare computerhulp in Eindhoven door ervaren IT-studenten",
          ...
          <div className="max-w-7xl mx-auto container-padding">
            <div className="text-center mb-8">
              <div className="inline-flex items-center bg-blue-500/20 text-blue-400 px-4 py-2 rounded-full text-sm font-medium mb-6">
                ...
                Student Aan Huis Service Eindhoven
              </div>
              ...
              <p className="text-xl text-neural-300 max-w-4xl mx-auto leading-relaxed mb-8">
                Computerproblemen in Eindhoven? Onze IT-studenten komen naar je toe! Betaalbare hulp door lokale studenten. 
          ...
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
                Werkgebied Eindhoven & Omgeving
              </h2>
              <p className="text-xl text-neural-300">
                Onze IT-studenten komen naar alle wijken in en rondom Eindhoven
              </p>
            </div>
        ...
        <section className="section-spacing bg-white/5">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-neural-300">
                Snel, lokaal en betaalbaar - vakkundige hulp in Eindhoven
              </p>
            </div>
