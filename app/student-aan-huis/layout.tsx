...
export const metadata: Metadata = {
  ...
  description: 'ICT-student aan huis voor betaalbare computerhulp in heel Nederland. HBO-opgeleide studenten helpen met uw laptop, printer, WiFi en meer. €15,50 per kwartier. 7 dagen per week!',
  keywords: [
    'student aan huis',
  ...
  openGraph: {
    title: 'Student aan huis | Betaalbare IT-hulp aan huis | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten aan huis. €15,50 per kwartier + €10 voorrijkosten. Heel Nederland!',
  ...
  twitter: {
    ...
    description: 'Betaalbare computerhulp door IT-studenten aan huis. €15,50/kwartier. 7 dagen per week!',
