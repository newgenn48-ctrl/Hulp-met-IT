...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Veldhoven Centrum, Veldhoven Noord, Veldhoven Zuid, Meerveldhoven, d'Ekker, Zilverackers, Zeelst, Eindhoven, Waalre. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisVeldhovenPage() {
