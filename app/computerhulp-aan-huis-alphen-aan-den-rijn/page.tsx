...
const benefits = [
  { icon: Clock, text: 'Snelle hulp Alphen aan den Rijn' },
      ...
      <section className="hero-section relative flex items-start justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto container-padding text-center">
          ...
          <h1 className="text-5xl lg:text-7xl font-bold mb-6 leading-tight">
            ...
            <br />
            <span className="text-secondary-800">Alphen aan den Rijn</span>
          </h1>

          <p className="text-xl lg:text-2xl text-primary-700 max-w-4xl mx-auto mb-6 leading-relaxed">
            Computerhulp aan huis door vriendelijke specialisten in Alphen aan den Rijn. Wij komen <span className="text-primary-700 font-semibold">binnen 24-48u</span> naar u toe en lossen het snel en vakkundig voor u op!
          </p>
        ...
        <section className="section-spacing bg-neural-900/50">
          <div className="max-w-4xl mx-auto container-padding">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="glass-effect rounded-lg p-6">
                <h3 className="text-xl font-semibold text-secondary-800 mb-4">💻 Onze Services Alphen aan den Rijn</h3>
                <ul className="text-secondary-700 space-y-2">
                  <li>• Laptop reparatie Alphen aan den Rijn</li>
                  <li>• Virus verwijdering Alphen aan den Rijn</li>
