...
const CITY = 'Alphen aan den Rijn'
const SLUG = 'alphen-aan-den-rijn'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Alphen Centrum, Alphen Noord, Alphen Oost, Alphen West, Alphen Zuid, Koudekerk, Hazerswoude, Boskoop, Nieuwkoop, Ter Aar. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]
