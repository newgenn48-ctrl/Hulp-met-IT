...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Enkhuizen-Centrum, Gommerwijk, Fruittuinen, Kadijken, Westerstrand, Enkhuizen-Zuid. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisEnkhuizenPage() {
