...
const CITY = 'Utrechtse Heuvelrug'
const SLUG = 'utrechtse-heuvelrug'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Doorn, Driebergen-Rijsenburg, Amerongen, Maarn, Leersum, Overberg, Woudenberg, Maarsbergen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisUtrechtseHeuvelrug() {
