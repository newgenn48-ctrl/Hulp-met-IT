...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: De Bilt Centrum, Bilthoven, Groenekan, Westbroek, Hollandsche Rading, Maartensdijk, Zeist, Utrecht. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisDeBilt() {
