...
const CITY = 'IJsselstein'
const SLUG = 'ijsselstein'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: IJsselstein Centrum, IJsselstein Noord, IJsselstein Zuid, Zenderpark, Achterveld, Groenvliet, Nieuwegein, Lopik, Montfoort. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisIjsselstein() {
