...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Bussum Centrum, Bussum Noord, Bussum Oost, Bussum West, Bussum Zuid, Brink, Naarden, Laren, Hilversum, Huizen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisBussum() {
