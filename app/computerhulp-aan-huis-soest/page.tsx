...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Soest Centrum, Soest Noord, Soest Oost, Soest West, Soest Zuid, Soesterberg, Soestduinen, Baarn, Amersfoort, Zeist. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisSoest() {
