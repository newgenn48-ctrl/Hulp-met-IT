...
export const metadata: Metadata = {
  ...
  description: 'Computerhulp aan huis in Soest door HBO-opgeleide ICT-studenten. Hulp in Soest Centrum, Soest Noord, Soest Oost en omgeving. €14,50/kwartier. 7 dagen per week!',
  keywords: [
  ...
  twitter: {
    ...
    title: 'Computerhulp aan huis Soest | Hulp met IT',
    description: 'Computerhulp aan huis in Soest. HBO ICT-student komt bij u thuis. €14,50/kwartier + €10 voorrijkosten.',
