...
export const metadata: Metadata = {
  ...
  description: 'Computerhulp aan huis in Soest voor alle computerproblemen. IT-specialisten met 10+ jaar ervaring bij u thuis. Vanaf €53,50 (€10 voorrijkosten + 3 x €14,50). Vandaag nog beschikbaar!',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Computerhulp aan huis in Soest door IT-specialisten met 10+ jaar ervaring. Vanaf €53,50 (€10 voorrijkosten + 3 x €14,50). Ook avond en weekend!',
  ...
  twitter: {
    ...
    description: 'Computerhulp aan huis Soest. Specialist komt bij u. Vanaf €53,50 (€10 voorrijkosten + 3 x €14,50).',
  },
  robots: {
    index: true,
    follow: true,
