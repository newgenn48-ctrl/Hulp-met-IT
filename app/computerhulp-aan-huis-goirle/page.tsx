...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Goirle Centrum, Riel, Goirle Noord, Goirle Zuid, Boerdonk, Abcoven. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisGoirle() {
