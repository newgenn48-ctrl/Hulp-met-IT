...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Rijen, Gilze, Molenschot, Rijen Centrum, Gilze Centrum, Hulten. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisGilzeEnRijenPage() {
