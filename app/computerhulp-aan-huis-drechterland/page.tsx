...
const CITY = 'Drechterland'
const SLUG = 'drechterland'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Hoogkarspel, Venhuizen, Hem, Oosterblokker, Wijdenes, Westwoud, Schellinkhout. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisDrechterland() {
