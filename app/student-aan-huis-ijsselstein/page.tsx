...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: IJsselstein Centrum, IJsselstein Noord, IJsselstein Zuid, Zenderpark, Achterveld, Groenvliet, Nieuwegein, Lopik, Montfoort. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisIjsselsteinPage() {
