...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Weesp Centrum, Weesp Noord, Weesp Oost, Weesp West, Weesp Zuid, Naarden, Muiden, Amsterdam, Hilversum, Bussum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisWeespPage() {
