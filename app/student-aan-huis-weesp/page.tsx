...
const faqData = [
  ...
  },
  {
    ...
    answer: `Ja, onze studenten in ${CITY} volgen IT-opleidingen aan Hogeschool Utrecht, UvA en andere hogescholen en universiteiten. Ze worden geselecteerd op technische én communicatieve vaardigheden. Alle studenten zijn gescreend.`
  },
  {
...
export default function StudentAanHuisCityPage() {
  ...
  return (
    <>
      ...
      <CityAboutSection citySlug="weesp" pageType="student" />
      ...
      <NearbyCities currentCitySlug="weesp" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-weesp" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
