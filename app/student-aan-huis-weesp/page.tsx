...
const CITY = 'Weesp'
const LOCAL_INSTITUTION = 'Hogeschool Utrecht en UvA'
...
const cityAreas = [
  'Weesp Centrum', 'Weesp Noord', 'Muiden', 'Muiderberg',
  'Naarden', 'Bussum', 'Diemen', 'Amsterdam Zuidoost',
  'Abcoude', 'Nigtevecht', 'Vreeland', 'Nederhorst den Berg'
]
...
const faqData = [
  ...
  },
  {
    ...
    answer: `We bedienen ${CITY} en alle omliggende plaatsen, waaronder Muiden, Muiderberg, Naarden, Bussum, Diemen, Amsterdam Zuidoost, Abcoude, Nigtevecht en Nederhorst den Berg.`
  }
]
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "areaServed": [
              { "@type": "City", "name": CITY },
              { "@type": "City", "name": "Muiden" },
              { "@type": "City", "name": "Muiderberg" },
      ...
      <section className="relative flex items-start justify-center overflow-hidden min-h-[600px] lg:min-h-[700px] pt-20">
        ...
        <div className="relative z-10 max-w-6xl mx-auto container-padding text-center flex items-center min-h-[600px] lg:min-h-[700px]">
          ...
          <p className="text-xl lg:text-2xl text-white max-w-4xl mx-auto mb-6 leading-relaxed">
            Heeft u vragen of problemen met uw computer, laptop, tablet of smartphone? Onze IT-studenten van {LOCAL_INSTITUTION} komen bij u thuis in <span className="font-semibold">{CITY} en omgeving</span>. U krijgt rustige, geduldige hulp zodat u alles goed begrijpt. Betrouwbaar en betaalbaar.
          </p>
          ...
          <div className="max-w-6xl mx-auto container-padding">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Onze IT-studenten zijn opgeleid in de nieuwste technologieen en kennen de regio goed. Snel ter plaatse in {CITY}.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <h3 className="text-xl font-semibold text-secondary-800 mb-3">{CITY} & Omgeving</h3>
                <p className="text-secondary-700 leading-relaxed">
                  Van {CITY} tot Muiden, van Naarden tot Diemen - onze studenten komen overal in de regio.
                </p>
              </div>
