...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Hillegom Centrum, Elsbroek, Hillegom-Noord, Hillegom-Zuid, Pastoorslaan-gebied, Ringvaart-omgeving. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHillegom() {
