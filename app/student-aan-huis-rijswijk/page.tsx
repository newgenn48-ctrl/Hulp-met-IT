...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Rijswijk Centrum, Rijswijk-Zuid, Ypenburg, Plaspoelpolder, Bomenbuurt, Stervoorde, Te Werve, Delft, Wateringen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisRijswijkPage() {
