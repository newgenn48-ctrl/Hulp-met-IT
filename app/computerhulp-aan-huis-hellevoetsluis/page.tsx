...
const CITY = 'Hellevoetsluis'
const SLUG = 'hellevoetsluis'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Hellevoetsluis Centrum, De Vesting, Nieuw-Helvoet, Kickersbloem, De Ravense Hoek, Oudenhoorn, Nieuwenhoorn, Struytse Hoek. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHellevoetsluis() {
