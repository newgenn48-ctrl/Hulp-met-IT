...
const CITY = 'Veldhoven'
const SLUG = 'veldhoven'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Veldhoven Centrum, Veldhoven Noord, Veldhoven Zuid, Meerveldhoven, d'Ekker, Zilverackers, Zeelst, Eindhoven, Waalre. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisVeldhoven() {
