...
const CITY = 'Voorne aan Zee'
const SLUG = 'voorne-aan-zee'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Hellevoetsluis, Brielle, Rockanje, Oostvoorne, Vierpolders, Zwartewaal, Nieuwenhoorn, Tinte. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisVoorneAanZee() {
