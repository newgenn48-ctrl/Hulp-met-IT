...
const CITY = 'Papendrecht'
const SLUG = 'papendrecht'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Papendrecht Centrum, Papendrecht Noord, Papendrecht West, Westpolder, Kraaihoek, Molenvliet, Dordrecht, Sliedrecht, Alblasserdam. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisPapendrecht() {
