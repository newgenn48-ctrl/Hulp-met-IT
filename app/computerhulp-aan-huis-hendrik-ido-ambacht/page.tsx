...
const CITY = 'Hendrik-Ido-Ambacht'
const SLUG = 'hendrik-ido-ambacht'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Hendrik-Ido-Ambacht Centrum, Volgerlanden, Sandelingen-Ambacht, Boveneind, Oostendam, De Volgerlanden-West. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHendrikIdoAmbacht() {
