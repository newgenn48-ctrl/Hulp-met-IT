...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Goes Centrum, Goes Noord, Goes Oost, Goes West, Goes Zuid, Kloetinge, Wilhelminadorp, Goese Polder. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisGoes() {
