...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Kaatsheuvel, Loon op Zand dorp, De Moer, Kaatsheuvel Centrum, Kaatsheuvel Zuid, Kaatsheuvel Noord, Loon op Zand Centrum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisLoonOpZandPage() {
