...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Barendrecht Centrum, Carnisselande, Vrouwenpolder, Oranjewijk, Riederhoek, Buitenoord, Molenvliet. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisBarendrechtPage() {
