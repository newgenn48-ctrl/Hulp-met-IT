...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Lisse Centrum, Poelpolder, Meer en Dorp, Keukenhof-omgeving, Lisserbroek, Heereweg-gebied. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisLisse() {
