...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Hilversum Centrum, Hilversum Noord, Hilversum Oost, Hilversum West, Hilversum Zuid, Kerkelanden, 's-Graveland, Hilversumse Meent, Trompenberg, Bussum, Naarden, Laren. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisHilversumPage() {
