...
export const metadata: Metadata = {
  ...
  description: 'Computerhulp aan huis in Kaag en Braassem door HBO-opgeleide ICT-studenten. Hulp in Roelofarendsveen, Oude Wetering, Leimuiden en omgeving. €14,50/kwartier. 7 dagen per week!',
  keywords: [
  ...
  openGraph: {
    title: 'Computerhulp aan huis Kaag en Braassem | Hulp met IT',
    description: 'Computerhulp aan huis in Kaag en Braassem door HBO-opgeleide ICT-studenten. €14,50 per kwartier + €10 voorrijkosten. Ook avond en weekend!',
  ...
  twitter: {
    ...
    title: 'Computerhulp aan huis Kaag en Braassem | Hulp met IT',
    description: 'Computerhulp aan huis in Kaag en Braassem. HBO ICT-student komt bij u thuis. €14,50/kwartier + €10 voorrijkosten.',
