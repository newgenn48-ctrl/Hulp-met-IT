...
const CITY = 'Kaag en Braassem'
const SLUG = 'kaag-en-braassem'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Roelofarendsveen, Oude Wetering, Leimuiden, Rijnsaterwoude, Kaag, Bilderdam, Hoogmade, Woubrugge. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisKaagEnBraassem() {
