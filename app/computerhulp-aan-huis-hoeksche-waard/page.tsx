...
const CITY = 'Hoeksche Waard'
const SLUG = 'hoeksche-waard'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Oud-Beijerland, Strijen, Numansdorp, Klaaswaal, 's-Gravendeel, Puttershoek, Piershil, Zuid-Beijerland, Maasdam, Westmaas. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHoekscheWaard() {
