...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Alphen Centrum, Alphen Noord, Alphen Oost, Alphen West, Alphen Zuid, Koudekerk, Hazerswoude, Boskoop, Nieuwkoop, Ter Aar. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisAlphenAanDenRijnPage() {
