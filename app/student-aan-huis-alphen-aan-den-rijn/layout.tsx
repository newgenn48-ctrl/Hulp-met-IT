...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Alphen aan den Rijn voor computerhulp. HBO-opgeleide IT-studenten bij u thuis. Vanaf €14,50 per kwartier + €10 voorrijkosten.',
  keywords: [
