...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Alphen aan den Rijn voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Alphen Centrum, Alphen Noord, Alphen Oost en omgeving. €14,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Alphen aan den Rijn | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Alphen aan den Rijn. Wij komen bij u thuis in Alphen aan den Rijn en omgeving. €14,50 per kwartier.',
