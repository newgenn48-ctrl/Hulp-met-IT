...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Middelburg Centrum, Middelburg Noord, Middelburg Oost, Middelburg West, Middelburg Zuid, Vlissingen, Veere, Koudekerke, Arnemuiden, Goes. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisMiddelburgPage() {
