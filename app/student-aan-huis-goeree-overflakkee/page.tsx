...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Middelharnis, Sommelsdijk, Ouddorp, Goedereede, Dirksland, Stellendam, Oude-Tonge, Nieuwe-Tonge, Stad aan 't Haringvliet, Ooltgensplaat. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisGoereeOverflakkeePage() {
