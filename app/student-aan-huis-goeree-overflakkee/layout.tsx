...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Goeree-Overflakkee voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Middelharnis, Sommelsdijk, Ouddorp en omgeving. €15,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Goeree-Overflakkee | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Goeree-Overflakkee. Wij komen bij u thuis in Goeree-Overflakkee en omgeving. €15,50 per kwartier.',
