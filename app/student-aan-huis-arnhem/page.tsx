...
const areas = [
  'Arnhem Centrum', 'Velp', 'Presikhaaf', 'Malburgen',
  'Klarendal', 'Schuytgraaf', 'Oosterbeek', 'Doorwerth',
  'Elst', 'Duiven', 'Zevenaar', 'Westervoort'
]
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Ja, onze studenten in ${CITY} volgen IT-opleidingen aan de HAN University of Applied Sciences en andere instellingen. Ze worden geselecteerd op technische én communicatieve vaardigheden. Alle studenten zijn gescreend.`
  },
  {
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Student aan huis in Arnhem"
          fill
          priority
      ...
      <CityAboutSection citySlug="arnhem" pageType="student" />
      ...
      <NearbyCities currentCitySlug="arnhem" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-arnhem" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
