...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Uithoorn, De Kwakel, Thamerdal, Legmeer, Uithoorn-Centrum, Zijdelwaard. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisUithoornPage() {
