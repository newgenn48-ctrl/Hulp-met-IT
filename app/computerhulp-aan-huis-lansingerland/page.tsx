...
const CITY = 'Lansingerland'
const SLUG = 'lansingerland'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Berkel en Rodenrijs, Bergschenhoek, Bleiswijk, Noordeinde, Kruisweg, Rotte, Wilderszijde. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisLansingerland() {
