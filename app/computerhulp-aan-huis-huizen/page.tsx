...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Huizen Centrum, Huizen Noord, Huizen Oost, Huizen West, Huizen Zuid, Huizen Haven, Blaricum, Naarden, Bussum, Almere. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHuizen() {
