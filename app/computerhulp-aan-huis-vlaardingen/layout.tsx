...
export const metadata: Metadata = {
  ...
  description: 'Computerhulp aan huis in Vlaardingen door HBO-opgeleide ICT-studenten. Hulp in Vlaardingen Centrum, Vlaardingen Noord, Vlaardingen Oost en omgeving. €14,50/kwartier. 7 dagen per week!',
  keywords: [
  ...
  twitter: {
    ...
    title: 'Computerhulp aan huis Vlaardingen | Hulp met IT',
    description: 'Computerhulp aan huis in Vlaardingen. HBO ICT-student komt bij u thuis. €14,50/kwartier + €10 voorrijkosten.',
