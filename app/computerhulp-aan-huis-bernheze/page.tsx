...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Heesch, Nistelrode, Loosbroek, Vorstenbosch, Heeswijk-Dinther, Middelrode. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisBernheze() {
