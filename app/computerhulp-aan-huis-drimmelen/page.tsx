...
const CITY = 'Drimmelen'
const SLUG = 'drimmelen'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Made, Terheijden, Lage Zwaluwe, Hooge Zwaluwe, Wagenberg, Drimmelen dorp. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisDrimmelen() {
