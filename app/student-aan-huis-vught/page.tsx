...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Vught Centrum, Cromvoirt, Helvoirt, Villapark, Vught Noord, Vught Zuid, Taalstraat, Loyola. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisVughtPage() {
