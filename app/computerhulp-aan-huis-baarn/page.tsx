...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Baarn Centrum, Baarn Noord, Baarn Oost, Baarn West, Baarn Zuid, Soestdijk, Eembrugge, Lage Vuursche, Soest, Hilversum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisBaarn() {
