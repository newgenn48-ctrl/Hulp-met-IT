...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Obdam, De Goorn, Berkhout, Ursem, Spierdijk, Hensbroek, Avenhorn, Zuidermeer. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisKoggenlandPage() {
