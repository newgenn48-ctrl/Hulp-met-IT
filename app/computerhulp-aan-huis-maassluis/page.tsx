...
const CITY = 'Maassluis'
const SLUG = 'maassluis'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Maassluis Centrum, Koningshoek, Sluispolder, Het Balkon, Wipperspark, Kapelpolder, Vlaardingen, Hoek van Holland, Schiedam. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisMaassluis() {
