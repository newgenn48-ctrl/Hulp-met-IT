...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Nieuwegein Centrum, Batau, Galecop, Vreeswijk, Jutphaas, Doorslag, Fokkesteeg, IJsselstein, Vianen, Houten. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisNieuwegeinPage() {
