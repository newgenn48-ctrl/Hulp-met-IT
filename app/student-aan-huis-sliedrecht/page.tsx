...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Sliedrecht Centrum, Sliedrecht-Oost, Sliedrecht-West, Baanhoek, De Lock, Merwestein. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisSliedrechtPage() {
