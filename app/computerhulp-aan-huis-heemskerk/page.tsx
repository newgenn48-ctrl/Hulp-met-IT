...
const CITY = 'Heemskerk'
const SLUG = 'heemskerk'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Heemskerk, Assumburg, De Maer, Waterakkers, Heemskerk-West, Heemskerk-Oost. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHeemskerk() {
