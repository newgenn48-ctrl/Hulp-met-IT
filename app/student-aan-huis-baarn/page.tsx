...
const areas = [
  'Baarn Centrum', 'Baarn Noord', 'Lage Vuursche', 'Soest',
  'Soestdijk', 'Hilversum', 'Eemnes', 'Laren',
  'Amersfoort', 'Bunschoten', 'Blaricum', 'Maartensdijk'
]
...
export default function StudentAanHuisCityPage() {
  ...
  return (
    <>
      ...
      <CityAboutSection citySlug="baarn" pageType="student" />
      ...
      <NearbyCities currentCitySlug="baarn" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-baarn" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
