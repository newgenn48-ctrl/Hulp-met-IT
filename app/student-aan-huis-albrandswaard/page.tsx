...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Poortugaal, Rhoon, Portland, Rhoon Centrum, Poortugaal Centrum, Albrandswaard-West. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisAlbrandswaardPage() {
