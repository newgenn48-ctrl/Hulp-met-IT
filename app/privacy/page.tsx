      ...
      <section className="hero-section relative z-10">
        <div className="max-w-4xl mx-auto container-padding">
          ...
          <div className="card-3d space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold text-secondary-800 mb-4">2. Waarvoor gebruiken we je gegevens?</h2>
              <div className="text-secondary-700 space-y-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-secondary-800 mb-4">3. Cookies en tracking</h2>
              <div className="text-secondary-700 space-y-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-secondary-800 mb-4">4. Delen van gegevens</h2>
              <div className="text-secondary-700 space-y-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-secondary-800 mb-4">5. Jouw rechten</h2>
              <div className="text-secondary-700 space-y-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-secondary-800 mb-4">6. Beveiliging</h2>
              <div className="text-secondary-700 space-y-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-secondary-800 mb-4">7. Bewaarperiode</h2>
              <div className="text-secondary-700 space-y-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-secondary-800 mb-4">8. Contact en klachten</h2>
              <div className="text-secondary-700 space-y-3">
                <p><strong>Hulp met IT</strong><br />
                E-mail: info@hulpmetit.nl<br />
                Telefoon: Beschikbaar via contactformulier</p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-secondary-800 mb-4">9. Wijzigingen</h2>
