...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Waalwijk Centrum, Waalwijk Noord, Waalwijk Zuid, Baardwijk, Waspik, Sprang-Capelle, Besoijen, Kaatsheuvel. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisWaalwijk() {
