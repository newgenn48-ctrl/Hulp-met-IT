...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Heerhugowaard, Langedijk, Sint Pancras, Noord-Scharwoude, Zuid-Scharwoude, Broek op Langedijk, Heerhugowaard-Zuid, Heerhugowaard-Noord, De Noord. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisDijkEnWaardPage() {
