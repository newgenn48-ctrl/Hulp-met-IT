...
export const metadata: Metadata = {
  ...
  description: 'Computerhulp aan huis in Den Haag door HBO-opgeleide ICT-studenten. Hulp in Den Haag Centrum, Scheveningen, Benoordenhout en omgeving. €14,50/kwartier. 7 dagen per week!',
  keywords: [
  ...
  twitter: {
    ...
    title: 'Computerhulp aan huis Den Haag | Hulp met IT',
    description: 'Computerhulp aan huis in Den Haag. HBO ICT-student komt bij u thuis. €14,50/kwartier + €10 voorrijkosten.',
