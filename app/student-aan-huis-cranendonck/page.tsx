...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Budel, Maarheeze, Budel-Schoot, Budel-Dorplein, Gastel, Soerendonk, Budel Centrum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisCranendonckPage() {
