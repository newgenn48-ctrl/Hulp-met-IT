...
const CITY = 'Veenendaal'
const SLUG = 'veenendaal'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Veenendaal Centrum, Veenendaal Noord, Veenendaal Oost, Veenendaal West, Dragonder, De Engelenburg, French Lick, Rhenen, Renswoude, Ede. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisVeenendaal() {
