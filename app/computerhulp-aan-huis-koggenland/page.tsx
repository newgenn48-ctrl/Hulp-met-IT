...
const CITY = 'Koggenland'
const SLUG = 'koggenland'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Obdam, De Goorn, Berkhout, Ursem, Spierdijk, Hensbroek, Avenhorn, Zuidermeer. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisKoggenland() {
