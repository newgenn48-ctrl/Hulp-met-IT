...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Driebergen Centrum, Rijsenburg, Driebergen-Zuid, Driebergen-Noord, Doorn, Austerlitz, Zeist, Maarn. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisDriebergenRijsenburgPage() {
