...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Houten Centrum, Houten Noord, Houten Zuid, Het Oude Dorp, Castellum, Schalkwijk, 't Goy, Bunnik, Nieuwegein. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisHoutenPage() {
