...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Hoorn Centrum, Hoorn Noord, Kersenboogerd, Risdam, Grote Waal, Blokker, Zwaag, Enkhuizen, Medemblik. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHoorn() {
