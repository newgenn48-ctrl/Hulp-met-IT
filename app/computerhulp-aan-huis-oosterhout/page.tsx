...
const CITY = 'Oosterhout'
const SLUG = 'oosterhout'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Oosterhout Centrum, Oosterhout Noord, Oosterhout Oost, Slotjes, Vrachelen, Dommelbergen, Dorst, Den Hout. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisOosterhout() {
