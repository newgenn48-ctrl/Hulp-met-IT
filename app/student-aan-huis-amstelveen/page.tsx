...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Amstelveen Centrum, Amstelveen Noord, Amstelveen Zuid, Westwijk, Bovenkerk, Nes aan de Amstel, Bankras-Kostverloren, Waardhuizen, Ouderkerk aan de Amstel, Uithoorn. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisAmstelveenPage() {
