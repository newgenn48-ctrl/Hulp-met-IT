...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Deurne Centrum, Liessel, Vlierden, Neerkant, Walsberg, Zeilberg, Deurne Noord, Deurne Zuid. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisDeurnePage() {
