...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Deurne voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Deurne Centrum, Liessel, Vlierden en omgeving. €15,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Deurne | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Deurne. Wij komen bij u thuis in Deurne en omgeving. €15,50 per kwartier.',
