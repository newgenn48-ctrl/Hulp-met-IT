...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Hoofddorp Centrum, Floriande, Toolenburg, Bornholm, Pax, Nieuw-Vennep, Badhoevedorp, Aalsmeer, Rijsenhout, Cruquius. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHoofddorp() {
