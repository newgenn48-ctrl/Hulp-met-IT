...
const CITY = 'Valkenswaard'
const SLUG = 'valkenswaard'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Valkenswaard Centrum, Dommelen, Borkel en Schaft, Geenhoven, Lage Heide, De Belleman, Het Gegraaf. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisValkenswaard() {
