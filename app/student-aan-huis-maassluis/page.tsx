...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Maassluis Centrum, Koningshoek, Sluispolder, Het Balkon, Wipperspark, Kapelpolder, Vlaardingen, Hoek van Holland, Schiedam. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisMaassluisPage() {
