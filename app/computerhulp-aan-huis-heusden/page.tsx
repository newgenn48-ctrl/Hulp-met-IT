...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Vlijmen, Drunen, Heusden Vesting, Elshout, Haarsteeg, Nieuwkuijk, Oudheusden, Hedikhuizen. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHeusden() {
