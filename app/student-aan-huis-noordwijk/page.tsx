...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Noordwijk aan Zee, Noordwijk-Binnen, Noordwijkerhout, De Zilk, Langeveld, Offem, Boechorst. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisNoordwijkPage() {
