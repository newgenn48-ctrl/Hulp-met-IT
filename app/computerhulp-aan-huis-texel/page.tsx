...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Den Burg, De Koog, Oudeschild, Den Hoorn, De Cocksdorp, Oosterend, De Waal. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisTexel() {
