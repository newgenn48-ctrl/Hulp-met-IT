...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Boxtel Centrum, Boxtel Noord, Boxtel Zuid, Liempde, Lennisheuvel, Esch, Sint-Michielsgestel, Schijndel, Best. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisBoxtel() {
