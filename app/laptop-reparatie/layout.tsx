...
export const metadata: Metadata = {
  ...
  description: 'Laptop reparatie aan huis door HBO-opgeleide ICT-studenten. Traag, vastgelopen of kapot? Wij komen langs en repareren het. Vanaf €15,50 per kwartier.',
  keywords: [
    'laptop reparatie',
  ...
  openGraph: {
    ...
    description: 'Laptop reparatie aan huis door HBO-opgeleide ICT-studenten. Vanaf €15,50 per kwartier + €10 voorrijkosten.',
  ...
  twitter: {
    ...
    title: 'Laptop Reparatie aan Huis | Hulp met IT',
    description: 'Laptop reparatie aan huis door HBO-opgeleide ICT-studenten. Vanaf €15,50 per kwartier.',
