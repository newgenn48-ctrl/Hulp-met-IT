...
const CITY = 'Loon op Zand'
const SLUG = 'loon-op-zand'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Kaatsheuvel, Loon op Zand dorp, De Moer, Kaatsheuvel Centrum, Kaatsheuvel Zuid, Kaatsheuvel Noord, Loon op Zand Centrum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisLoonOpZand() {
