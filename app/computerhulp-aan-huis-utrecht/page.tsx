...
const benefits = [
  {
    icon: Clock,
    title: 'Snelle Hulp Utrecht',
    description: 'Wij komen snel naar u toe in heel Utrecht'
  },
  {
    icon: Award,
          ...
          <div className="max-w-7xl mx-auto container-padding">
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-gradient mb-6">
                ...
                <br />
                <span className="text-white">Utrecht</span>
              </h1>

              <p className="text-xl text-neural-300 max-w-4xl mx-auto leading-relaxed mb-8">
                Computerhulp aan huis door vriendelijke specialisten in Utrecht. Wij komen naar u toe in heel Utrecht en helpen rustig bij uw computerproblemen.
          ...
          <div className="max-w-4xl mx-auto container-padding">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="glass-effect rounded-lg p-6">
                <h3 className="text-xl font-semibold text-white mb-4">🏰 Utrecht Wijken</h3>
              ...
              <div className="glass-effect rounded-lg p-6">
                <h3 className="text-xl font-semibold text-white mb-4">💻 Onze Services Utrecht</h3>
                <ul className="text-neural-300 space-y-2">
