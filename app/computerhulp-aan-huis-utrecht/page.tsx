...
<div className="relative z-10 max-w-6xl mx-auto container-padding text-center flex items-center min-h-[600px] lg:min-h-[700px]">
          ...
          <p className="text-xl lg:text-2xl text-white max-w-4xl mx-auto mb-6 leading-relaxed">Rustige, vriendelijke hulp aan huis in Utrecht. Wij helpen u met uw computer, wifi, printer of telefoon.</p>
