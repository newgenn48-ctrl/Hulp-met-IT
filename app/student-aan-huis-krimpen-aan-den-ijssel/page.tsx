...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Krimpen Centrum, Langeland, Oud Krimpen, Stormpolder, Laning, Kortland. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisKrimpenAanDenIjsselPage() {
