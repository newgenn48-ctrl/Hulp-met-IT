...
const CITY = 'Steenbergen'
const SLUG = 'steenbergen'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Steenbergen Centrum, Dinteloord, Kruisland, Nieuw-Vossemeer, De Heen, Welberg. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisSteenbergen() {
