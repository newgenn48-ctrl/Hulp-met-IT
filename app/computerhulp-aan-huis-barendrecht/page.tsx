...
const CITY = 'Barendrecht'
const SLUG = 'barendrecht'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Barendrecht Centrum, Carnisselande, Vrouwenpolder, Oranjewijk, Riederhoek, Buitenoord, Molenvliet. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisBarendrecht() {
