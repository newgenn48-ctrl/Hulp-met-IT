...
const CITY = 'Stede Broec'
const SLUG = 'stede-broec'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Bovenkarspel, Grootebroek, Lutjebroek, Stede Broec-Centrum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisStedeBroec() {
