...
const CITY = 'Purmerend'
const SLUG = 'purmerend'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Purmerend Centrum, Purmerend Noord, Purmerend Zuid, Weidevenne, Overwhere, Wheermolen, Edam-Volendam, Monnickendam, Ilpendam, Beemster. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisPurmerend() {
