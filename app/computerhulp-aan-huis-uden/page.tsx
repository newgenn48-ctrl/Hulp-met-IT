...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Uden Centrum, Uden Noord, Uden Zuid, Uden Oost, Volkel, Odiliapeel, Veghel, Mill. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisUden() {
