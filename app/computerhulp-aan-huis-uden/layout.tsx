...
export const metadata: Metadata = {
  ...
  description: 'Computerhulp aan huis in Uden door HBO-opgeleide ICT-studenten. Hulp in Uden Centrum, Uden Noord, Uden Zuid en omgeving. €15,50/kwartier. 7 dagen per week!',
  keywords: [
  ...
  openGraph: {
    title: 'Computerhulp aan huis Uden | Hulp met IT',
    description: 'Computerhulp aan huis in Uden door HBO-opgeleide ICT-studenten. €15,50 per kwartier + €10 voorrijkosten. Ook avond en weekend!',
  ...
  twitter: {
    ...
    title: 'Computerhulp aan huis Uden | Hulp met IT',
    description: 'Computerhulp aan huis in Uden. HBO ICT-student komt bij u thuis. €15,50/kwartier + €10 voorrijkosten.',
