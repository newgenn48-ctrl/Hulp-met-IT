...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Helmond voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Helmond Centrum, Helmond Noord, Helmond Oost en omgeving. €15,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Helmond | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Helmond. Wij komen bij u thuis in Helmond en omgeving. €15,50 per kwartier.',
