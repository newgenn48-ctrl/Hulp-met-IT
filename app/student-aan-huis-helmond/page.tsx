...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Helmond Centrum, Helmond Noord, Helmond Oost, Helmond West, Brandevoort, Rijpelberg, Brouwhuis, Mierlo, Deurne. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
