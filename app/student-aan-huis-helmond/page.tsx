...
const faqData = [
  ...
  },
  {
    ...
    answer: `We bedienen heel ${CITY} en omgeving, inclusief Helmond Centrum, Helmond Noord, Helmond Oost, Helmond West, Brandevoort, Rijpelberg en meer.`
  }
]

export default function StudentAanHuisHelmondPage() {
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: 'https://hulpmetit.nl/student-aan-huis-helmond'
      }
    ]
  }
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Student aan huis in Helmond"
          fill
          priority
      ...
      <CityAboutSection citySlug="helmond" pageType="student" />
            ...
            <ScrollReveal>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900 mb-4">
                  Student aan huis in Helmond en omgeving
                </h2>
              </div>
            </ScrollReveal>
      ...
      <NearbyCities currentCitySlug="helmond" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-helmond" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
