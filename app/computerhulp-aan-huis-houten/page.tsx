...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Houten Centrum, Houten Noord, Houten Zuid, Het Oude Dorp, Castellum, Schalkwijk, 't Goy, Bunnik, Nieuwegein. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisHouten() {
