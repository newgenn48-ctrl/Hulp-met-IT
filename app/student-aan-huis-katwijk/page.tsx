...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Katwijk aan Zee, Katwijk aan den Rijn, Katwijk Centrum, Katwijk Noord, Katwijk Zuid, Rijnsburg, Valkenburg, Wassenaar, Noordwijk, Oegstgeest. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisKatwijkPage() {
