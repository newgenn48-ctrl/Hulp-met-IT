...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Sint-Michielsgestel, Berlicum, Den Dungen, Gemonde, Middelrode, Sint-Michielsgestel Centrum. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisSintMichielsgestelPage() {
