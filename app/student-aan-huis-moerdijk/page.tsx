...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Zevenbergen, Klundert, Fijnaart, Willemstad, Standdaarbuiten, Moerdijk dorp, Langeweg, Zevenbergschen Hoek. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisMoerdijkPage() {
