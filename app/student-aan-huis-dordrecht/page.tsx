...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Dordrecht Centrum, Dordrecht Noord, Dordrecht Oost, Dordrecht West, Dordrecht Zuid, Wielwijk, Dubbeldam, Sterrenburg, Krispijn, Papendrecht. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisDordrechtPage() {
