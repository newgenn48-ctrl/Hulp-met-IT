...
const areas = [
  'Dordrecht Centrum', 'Sterrenburg', 'Crabbehof', 'Dubbeldam',
  'Stadspolders', 'Zwijndrecht', 'Papendrecht', 'Sliedrecht',
  'Hendrik-Ido-Ambacht', 'Ridderkerk', 'Alblasserdam', 'Gorinchem'
]
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Ja, onze studenten in ${CITY} volgen IT-opleidingen aan onder andere Da Vinci College en andere instellingen. Ze worden geselecteerd op technische én communicatieve vaardigheden. Alle studenten zijn gescreend.`
  },
  {
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt="Student aan huis in Dordrecht"
          fill
          priority
      ...
      <CityAboutSection citySlug="dordrecht" pageType="student" />
      ...
      <NearbyCities currentCitySlug="dordrecht" pageType="student" />
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href="/computerhulp-aan-huis-dordrecht" className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
