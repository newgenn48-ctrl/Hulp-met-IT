...
const processSteps = [
  {
    step: '1',
    title: 'Plan Afspraak',
    description: 'Bel of plan online - binnen Dordrecht snel beschikbaar'
  },
  {
    step: '2',
    title: 'Student Komt Langs',
    description: 'IT-student komt naar je adres in Dordrecht'
  },
  {
    step: '3',
...
const dordrechtAreas = [
  'Dordrecht Centrum', 'Dordrecht Sterrenburg', 'Dordrecht Dubbeldam', 'Dordrecht Krispijn',
  'Dordrecht Wielwijk', 'Dordrecht Stadspolders', 'Dordrecht Reeland', 'Dordrecht Donkersloot',
  'Dordrecht Stadshoven', 'Dordrecht Leerpark', 'Dordrecht Wantijpark', 'Dordrecht Papendrecht'
]

const faqData = [
  {
    question: "Wat kost student aan huis hulp in Dordrecht?",
    answer: "Onze tarieven beginnen vanaf €53,50 (€10 voorrijkosten + 3 x €14,50) in Dordrecht. Dit is veel voordeliger dan traditionele computerhulp services. Je betaalt alleen voor de daadwerkelijk bestede tijd, geen voorrijkosten of minimumtarief."
  },
  {
    question: "Zijn jullie studenten wel gekwalificeerd in Dordrecht?",
    answer: "Ja, onze studenten in Dordrecht volgen IT-opleidingen en hebben praktijkervaring. Ze zijn vertrouwd met moderne technologie en worden geselecteerd op hun technische vaardigheden en communicatieve vaardigheden."
  },
  {
    question: "Kunnen jullie ook 's avonds en weekenden komen in Dordrecht?",
    answer: "Ja, dat is een van onze grote voordelen! Onze studenten in Dordrecht hebben flexibele schema's en kunnen vaak ook 's avonds en in weekenden. We zijn bereikbaar van 08:00 tot 22:00, 7 dagen per week."
  },
  {
    question: "Hoe snel kunnen jullie komen in Dordrecht?",
    answer: "In Dordrecht kunnen we vaak nog dezelfde dag langskomen, vooral 's avonds en in weekenden. Voor urgent problemen proberen we binnen 2-4 uur beschikbaar te zijn."
  },
  {
    question: "Welke wijken in Dordrecht bedienen jullie?",
    answer: "We bedienen alle wijken van Dordrecht: Centrum, Sterrenburg, Dubbeldam, Krispijn, Wielwijk, Stadspolders, Reeland, Donkersloot en omliggende gebieden."
  }
]
...
export default function StudentAanHuisDordrechtLanding() {
...
<script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Hulp met IT - Student Aan Huis Dordrecht",
            "description": "Betaalbare computerhulp in Dordrecht door ervaren IT-studenten",
      ...
      <div className="relative">
          ...
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Hoe Werkt Student Aan Huis in Dordrecht?
              </h2>
              <p className="text-xl text-secondary-700">
                Snel, lokaal en betaalbaar - vakkundige hulp in Dordrecht
              </p>
            </div>
        ...
        <section className="section-spacing bg-neural-900/30">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Waarom kiezen voor onze Student Aan Huis in Dordrecht?
              </h2>
              <p className="text-xl text-secondary-700 max-w-3xl mx-auto">
                Ontdek de voordelen van computerhulp door ervaren IT-studenten in Dordrecht
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="glass-effect rounded-lg p-6">
                ...
                <h3 className="text-xl font-semibold text-secondary-800 mb-3">Betaalbare Tarieven Dordrecht</h3>
                <p className="text-secondary-700 leading-relaxed">
                  Vanaf €53,50 (€10 voorrijkosten + 3 x €14,50) in Dordrecht - veel goedkoper dan traditionele computerhulp. Perfecte kwaliteit tegen studententarieven.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Onze studenten in Dordrecht zijn opgeleid in de nieuwste technologieën en kennen de stad goed. Snel ter plaatse.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Ook 's avonds en in weekenden beschikbaar in Dordrecht. Studenten hebben flexibele schema's.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <h3 className="text-xl font-semibold text-secondary-800 mb-3">Heel Dordrecht</h3>
                <p className="text-secondary-700 leading-relaxed">
                  Van Centrum tot Sterrenburg, van Dubbeldam tot Krispijn - onze studenten komen overal in Dordrecht.
                </p>
              </div>
              ...
              <div className="glass-effect rounded-lg p-6">
                ...
                <p className="text-secondary-700 leading-relaxed">
                  Vaak nog dezelfde dag beschikbaar in Dordrecht. Korte reistijd betekent snelle hulp.
                </p>
              </div>
        ...
        <section className="section-spacing">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Onze Student IT Diensten in Dordrecht
              </h2>
              <p className="text-xl text-secondary-700">
                Uitgebreide computerhulp door vakkundige IT-studenten in Dordrecht
              </p>
            </div>

            <div className="grid lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-secondary-800 mb-4">🖥️ Computer & Laptop Hulp Dordrecht</h3>
              ...
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-secondary-800 mb-4">🌐 Internet & Netwerk Dordrecht</h3>
        ...
        <section className="section-spacing bg-neural-900/50">
          ...
          <div className="max-w-4xl mx-auto container-padding">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Veelgestelde Vragen Student Aan Huis Dordrecht
              </h2>
              <p className="text-xl text-secondary-700">
                Antwoorden op de meest gestelde vragen over onze student IT service in Dordrecht
              </p>
            </div>
        ...
        {/* Dordrecht Areas Section */}
        <section className="section-spacing">
          <div className="max-w-6xl mx-auto container-padding">
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-4">
                Werkgebied Dordrecht & Omgeving
              </h2>
              <p className="text-xl text-secondary-700">
                Onze IT-studenten komen naar alle wijken in en rondom Dordrecht
              </p>
            </div>

            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
              {dordrechtAreas.map((area, index) => (
            ...
            <div className="text-center">
              ...
              <Link href="/regios/dordrecht" className="btn-secondary">
        ...
        <section className="section-spacing bg-gradient-to-br from-primary-50 via-white to-accent-50">
          <div className="max-w-4xl mx-auto container-padding text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-secondary-800 mb-6">
              Klaar voor Betaalbare Computerhulp in Dordrecht?
            </h2>
