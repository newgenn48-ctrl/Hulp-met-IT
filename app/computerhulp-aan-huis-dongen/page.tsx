...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Dongen Centrum, Dongen Noord, Dongen Zuid, 's Gravenmoer, Klein-Dongen, De Biezen, Loon op Zand, Oosterhout, Waalwijk. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisDongen() {
