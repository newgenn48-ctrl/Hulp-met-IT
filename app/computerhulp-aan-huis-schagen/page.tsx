...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Schagen, Tuitjenhorn, Warmenhuizen, Dirkshorn, Callantsoog, Sint Maartensbrug, Petten, Schagerbrug. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisSchagen() {
