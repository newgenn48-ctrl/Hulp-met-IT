...
const CITY = 'Beverwijk'
const SLUG = 'beverwijk'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Beverwijk, Wijk aan Zee, Westerhout, Beverwijk-Zuid, Beverwijk-Oost, Meerestein. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisBeverwijk() {
