...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Hellevoetsluis Centrum, De Vesting, Nieuw-Helvoet, Kickersbloem, De Ravense Hoek, Oudenhoorn, Nieuwenhoorn, Struytse Hoek. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisHellevoetsluisPage() {
