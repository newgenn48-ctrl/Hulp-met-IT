...
export const metadata: Metadata = {
  ...
  description: 'ICT Student aan huis in Dongen voor betaalbare computerhulp. Ervaren IT-studenten komen bij u thuis in Dongen Centrum, Dongen Noord, Dongen Zuid en omgeving. €15,50 per kwartier. Snel, vakkundig en vriendelijk!',
  keywords: [
  ...
  openGraph: {
    title: 'Student aan huis Dongen | Hulp met IT',
    description: 'Betaalbare computerhulp door ervaren IT-studenten in Dongen. Wij komen bij u thuis in Dongen en omgeving. €15,50 per kwartier.',
