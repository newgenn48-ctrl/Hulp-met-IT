...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Gorinchem Centrum, Gorinchem Oost, Gorinchem West, Haarwijk, Stalkaarsen, Dalem, Leerdam, Hardinxveld-Giessendam, Sliedrecht. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisGorinchemPage() {
