...
const CITY = 'Albrandswaard'
const SLUG = 'albrandswaard'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Poortugaal, Rhoon, Portland, Rhoon Centrum, Poortugaal Centrum, Albrandswaard-West. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisAlbrandswaard() {
