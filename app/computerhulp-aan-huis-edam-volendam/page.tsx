...
const CITY = 'Edam-Volendam'
const SLUG = 'edam-volendam'
...
const faqData = [
  ...
  },
  {
    ...
    answer: `Wij bieden computerhulp aan huis in heel ${CITY}: Edam, Volendam, Zeevang, Kwadijk, Oosthuizen, Warder, Hobrede. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  }
]

export default function ComputerhulpAanHuisEdamVolendam() {
