          ...
          <div className="max-w-2xl">
            <ScrollReveal>
              ...
              <p className="text-lg text-white/80 leading-relaxed mb-4 max-w-lg">
                Heeft u problemen met uw computer, tablet of telefoon? Geen zorgen — onze IT-studenten komen bij u thuis in heel Nederland en helpen u stap voor stap, in begrijpelijke taal.
              </p>
