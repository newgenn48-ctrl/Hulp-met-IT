...
const faqData = [
  ...
  },
  {
    ...
    answer: `Onze studenten aan huis bedienen heel ${CITY}: Hoogkarspel, Venhuizen, Hem, Oosterblokker, Wijdenes, Westwoud, Schellinkhout. Waar u ook woont in ${CITY}, wij komen bij u thuis.`
  },
  {
...
export default function StudentAanHuisDrechterlandPage() {
