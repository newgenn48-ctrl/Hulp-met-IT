...
const faqData = [
  {
    ...
    answer: "Onze computerhulp aan huis in Amsterdam begint vanaf €53,50 voor 3 kwartier. Voor 1 uur betaalt u €69,50. Wij werken met transparante prijzen zonder verborgen kosten."
  },
  {
