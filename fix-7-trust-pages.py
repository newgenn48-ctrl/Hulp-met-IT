...
def add_trust_manually(city_slug, city_name):
    """Manually add trust section"""
...
'''
    ...
    # Insert before the SEO section (section-spacing bg-neural-900/50)
...
# Fix all 7 pages
fixed = 0
for city_slug, city_name in missing_cities.items():
    if add_trust_manually(city_slug, city_name):
