...
const cities = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'lib', 'data', 'cities.json'), 'utf-8'))
...
function generateComputerhulpPage(city) {
  const { name, slug, region, serviceAreas } = city
  const FUNC = `ComputerhulpAanHuis${slugToPascalCase(slug)}`
  const areas = serviceAreas || []
  const first3 = areas.slice(0, 3).join(', ')
  const allAreas = areas.join(', ')
  // Pick 3 areas for the about text "Of u nu woont in X, Y of Z"
  const aboutAreas = areas.length >= 3
    ? `${areas[0]}, ${areas[1]} of ${areas[2]}`
    : areas.join(' of ')
...
const faqData = [
  ...
  },
  {
    ...
    answer: \`Voor computerhulp aan huis in \${CITY} kunnen wij vaak nog dezelfde dag bij u langskomen. In de meeste gevallen bent u binnen 24 uur geholpen. Wij zijn actief in heel \${CITY} en de regio \${REGION}.\`
  },
  {
    question: \`Welke problemen lossen jullie op in \${CITY}?\`,
    answer: \`Onze computerhulp aan huis in \${CITY} omvat onder andere: trage computers, virusverwijdering, internet- en wifi-problemen, e-mail instellen, printers aansluiten, software installatie, Windows updates, laptop reparatie en data-backup. Wij nemen de tijd om alles uit te leggen.\`
  },
  {
    question: \`Hebben jullie ervaring met computerhulp aan huis in \${CITY}?\`,
    answer: \`Ja, onze HBO-opgeleide ICT-studenten hebben ruime ervaring met computerhulp aan huis in \${CITY}. Wij helpen dagelijks inwoners van \${CITY} met pc hulp, laptop problemen en andere IT-vragen. Alle studenten zijn gescreend en geselecteerd op technische \\u00e9n communicatieve vaardigheden.\`
  },
  {
    question: \`Werken jullie ook in het weekend in \${CITY}?\`,
    answer: \`Ja, wij bieden computerhulp aan huis in \${CITY} van maandag tot en met zondag. Onze studenten zijn beschikbaar van 08:00 tot 21:00 uur \\u2014 ook in de avonduren en het weekend. Ideaal als u doordeweeks geen tijd heeft.\`
  },
  {
    question: \`Welke wijken in \${CITY} bedienen jullie?\`,
    answer: \`Wij bieden computerhulp aan huis in heel \${CITY}: ${allAreas}. Waar u ook woont in \${CITY}, wij komen bij u thuis.\`
  }
]
...
export default function ${FUNC}() {
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: \`Computerhulp aan huis \${CITY}\`,
        item: \`https://hulpmetit.nl/computerhulp-aan-huis-\${SLUG}\`
      }
    ]
  }
  ...
  const serviceStructuredData = {
    ...
    '@type': 'Service',
    name: \`Computerhulp aan huis \${CITY}\`,
    description: \`Professionele computerhulp aan huis in \${CITY} door HBO-opgeleide ICT-studenten\`,
    provider: {
      '@type': 'LocalBusiness',
      name: 'Hulp met IT',
  ...
  const localBusinessStructuredData = {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    name: \`Hulp met IT - Computerhulp aan Huis \${CITY}\`,
    description: \`Professionele computerhulp aan huis in \${CITY} door HBO-opgeleide ICT-studenten\`,
    url: \`https://hulpmetit.nl/computerhulp-aan-huis-\${SLUG}\`,
    telephone: '+31858005006',
    ...
    <>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        <Image
          ...
          alt={\`IT-student geeft computerhulp aan huis in \${CITY}\`}
          fill
          priority
      ...
      <section className="py-20 lg:py-28 bg-secondary-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900">
                Computerhulp aan huis in {CITY} — in 3 stappen
              </h2>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-3 gap-4 sm:gap-8">
            {[
              { icon: PhoneCall, step: '1', title: 'Bel of plan online', desc: \`Neem contact op via telefoon of plan online een afspraak voor computerhulp aan huis in \${CITY}. Vertel kort wat het probleem is.\` },
              { icon: UserCheck, step: '2', title: 'Student komt langs', desc: \`Een HBO-opgeleide ICT-student komt op de afgesproken tijd bij u thuis in \${CITY}. Geen gedoe met wegbrengen.\` },
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-secondary-900">
                Veelgestelde vragen over computerhulp aan huis in {CITY}
              </h2>
            </div>
          </ScrollReveal>
      ...
      <section className="py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-secondary-600">
            ...
            <a href={\`/student-aan-huis-\${SLUG}\`} className="text-primary-600 hover:text-primary-700 font-medium underline underline-offset-2">
...
function generateStudentPage(city) {
  const { name, slug, region, serviceAreas } = city
  const FUNC = `StudentAanHuis${slugToPascalCase(slug)}Page`
  const areas = serviceAreas || []
  const allAreas = areas.join(', ')
  const aboutAreas = areas.length >= 3
    ? `${areas[0]}, ${areas[1]} of ${areas[2]}`
...
const faqData = [
  ...
  },
  {
    ...
    answer: \`Onze studenten aan huis bedienen heel \${CITY}: ${allAreas}. Waar u ook woont in \${CITY}, wij komen bij u thuis.\`
  },
  {
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div>
              ...
              <p className="text-secondary-600 leading-relaxed mb-4">
                Onze studenten zijn actief in heel {CITY} en omgeving. Of u nu woont in ${aboutAreas}; wij zijn snel ter plaatse om u te helpen met uw <a href="/diensten/computerhulp" className="text-primary-600 hover:text-primary-700 underline underline-offset-2">laptop</a>, <a href="/diensten/printerhulp" className="text-primary-600 hover:text-primary-700 underline underline-offset-2">printer</a>, <a href="/diensten/internet-wifi" className="text-primary-600 hover:text-primary-700 underline underline-offset-2">WiFi</a> of <a href="/diensten/email-problemen" className="text-primary-600 hover:text-primary-700 underline underline-offset-2">e-mail</a>. Naast hulp aan huis bieden wij ook hulp op afstand voor kleine vragen.
              </p>
              <p className="text-secondary-600 leading-relaxed">
...
let computerhulpCount = 0
let studentCount = 0
let skipped = []

cities.forEach(city => {
  // Computerhulp page
  const computerhulpDir = path.join(appDir, `computerhulp-aan-huis-${city.slug}`)
  if (fs.existsSync(computerhulpDir)) {
    fs.writeFileSync(path.join(computerhulpDir, 'page.tsx'), generateComputerhulpPage(city))
    computerhulpCount++
  } else {
    skipped.push(`computerhulp-aan-huis-${city.slug}`)
  }

  // Student page
  const studentDir = path.join(appDir, `student-aan-huis-${city.slug}`)
  if (fs.existsSync(studentDir)) {
    fs.writeFileSync(path.join(studentDir, 'page.tsx'), generateStudentPage(city))
    studentCount++
  } else {
    skipped.push(`student-aan-huis-${city.slug}`)
  }
})

console.log(`\nDone!`)
console.log(`  Computerhulp pages: ${computerhulpCount}`)
console.log(`  Student pages: ${studentCount}`)
console.log(`  Total: ${computerhulpCount + studentCount}`)
if (skipped.length > 0) {
  console.log(`  Skipped (dir not found): ${skipped.join(', ')}`)
}
